    ...
    def __init__(
        ...
        *,
        ...
        if select_mouse == "RIGHT":
            ...
            if use_alt_tool_or_cursor:
                self.cursor_set_event = {
                    "type": "LEFTMOUSE",
                    "value": "PRESS",
                    "alt": True,
                }
                self.cursor_tweak_event = {
                    "type": "LEFTMOUSE",
                    "value": "CLICK_DRAG",
                    "alt": True,
                }
        ...
        self.use_fallback_tool_select_mouse = (
            True if (select_mouse == "LEFT") else self.use_fallback_tool
        )
        self.select_mouse_value_fallback = (
            "CLICK"
            if (self.use_fallback_tool and select_mouse == "RIGHT")
            else self.select_mouse_value
        )
        ...
        self.tool_maybe_tweak_event = {
            "type": self.tool_mouse,
            "value": self.tool_maybe_tweak_value,
        }
...
def _template_space_region_type_toggle(
    *, toolbar_key=None, sidebar_key=None, channels_key=None
):
    items = []
...
def _template_items_gizmo_tweak_value():
    return [
        (
            ...
            {"type": "LEFTMOUSE", "value": "PRESS", **any_except("alt")},
            None,
        ),
    ]
...
def _template_items_gizmo_tweak_value_click_drag():
    return [
        (
            "gizmogroup.gizmo_tweak",
            {"type": "LEFTMOUSE", "value": "CLICK", **any_except("alt")},
            None,
        ),
        (
            "gizmogroup.gizmo_tweak",
            {"type": "LEFTMOUSE", "value": "CLICK_DRAG", **any_except("alt")},
            None,
        ),
    ]
...
def _template_items_change_frame(params):
    if params.select_mouse == "LEFTMOUSE" and not params.legacy:
        ...
        return [
            (
                "anim.change_frame",
                {"type": params.action_mouse, "value": "PRESS"},
                None,
            ),
        ]
...
def km_window(params):
    ...
    if params.legacy:
        ...
        items.extend(
            [
                ...
                (
                    "wm.link",
                    {"type": "O", "value": "PRESS", "ctrl": True, "alt": True},
                    None,
                ),
    ...
    items.extend(
        [
            # File operations
            op_menu(
                "TOPBAR_MT_file_new", {"type": "N", "value": "PRESS", "ctrl": True}
            ),
            op_menu(
    ...
    if not params.legacy:
        ...
        items.extend(
            [
                ...
                op_menu(
                    "TOPBAR_MT_file_context_menu", {"type": "F4", "value": "PRESS"}
                ),
    ...
    items.extend(
        [
            ...
            *_template_items_hide_reveal_actions(
                "mask.hide_view_set", "mask.hide_view_clear"
            ),
            (
                "clip.select",
            ...
            (
                "mask.normals_make_consistent",
                {
                    "type": "N",
                    "value": "PRESS",
                    "ctrl" if params.legacy else "shift": True,
                },
                None,
            ),
            ...
            (
                "transform.translate",
                {"type": params.select_mouse, "value": "CLICK_DRAG"},
                None,
            ),
...
def km_outliner(params):
    ...
    items.extend(
        [
            ...
            op_menu_pie(
                "OUTLINER_MT_view_pie", {"type": "ACCENT_GRAVE", "value": "PRESS"}
            ),
            (
    ...
    items.extend(
        [
            ...
            *_template_items_hide_reveal_actions("uv.hide", "uv.reveal"),
            ...
            op_menu(
                "IMAGE_MT_uvs_align", {"type": "W", "value": "PRESS", "shift": True}
            ),
            ...
            (
                ...
                if not params.legacy
                    ...
                    "IMAGE_MT_uvs_snap", {"type": "S", "value": "PRESS", "shift": True}
                )
            ),
            *_template_items_proportional_editing(
                params,
            ...
            op_tool_optional(
                ("transform.translate", {"type": "G", "value": "PRESS"}, None),
                (op_tool_cycle, "builtin.move"),
                params,
            ),
            op_tool_optional(
                ("transform.rotate", {"type": "R", "value": "PRESS"}, None),
                (op_tool_cycle, "builtin.rotate"),
                params,
            ),
            op_tool_optional(
                ("transform.resize", {"type": "S", "value": "PRESS"}, None),
                (op_tool_cycle, "builtin.scale"),
                params,
            ),
            (
                "transform.shear",
            ...
            *_template_items_context_menu(
                "IMAGE_MT_uvs_context_menu", params.context_menu_event
            ),
        ]
    )
    ...
    if params.use_mouse_emulate_3_button and params.select_mouse == "LEFTMOUSE":
        items.extend(
            [
                (
                    "uv.select_loop",
                    {"type": params.select_mouse, "value": "DOUBLE_CLICK"},
                    None,
                ),
                (
                    "uv.select_loop",
                    {"type": params.select_mouse, "value": "DOUBLE_CLICK", "alt": True},
                    {"properties": [("extend", True)]},
                ),
            ]
        )
    ...
    items.extend(
        [
            ...
            *(
            ...
            op_menu_pie(
                "VIEW3D_MT_view_pie"
                if params.v3d_tilde_action == "VIEW"
                else "VIEW3D_MT_transform_gizmo_pie",
                {"type": "ACCENT_GRAVE", "value": params.pie_value},
            ),
            *(
                ()
                if not params.use_pie_click_drag
                else (
                    (
                        "view3d.navigate",
            ...
            *(
                ...
                if params.v3d_alt_mmb_drag_action == "RELATIVE"
                else (
                    (
                        "view3d.view_axis",
                        {
            ...
            *_template_view3d_select(
            ...
            op_tool_optional(
                ...
                (op_tool_cycle, "builtin.to_sphere"),
                params,
            ),
            op_tool_optional(
                (
            ...
            (
                op_menu_pie(
                    "VIEW3D_MT_snap_pie", {"type": "S", "value": "PRESS", "shift": True}
                )
                if not params.legacy
                else op_menu(
                    "VIEW3D_MT_snap", {"type": "S", "value": "PRESS", "shift": True}
                )
            ),
        ]
    )
    ...
    if not params.legacy:
        ...
        items.extend(
            [
                ...
                op_menu_pie(
                    "VIEW3D_MT_pivot_pie", {"type": "PERIOD", "value": "PRESS"}
                ),
                op_menu_pie(
                ...
                op_menu_pie(
                    ...
                    if not params.use_v3d_shade_ex_pie
                    else "VIEW3D_MT_shading_ex_pie",
        ...
        items.extend(
            [
                ...
                (
                    ...
                    {"type": "NUMPAD_PERIOD", "value": "PRESS", "shift": True},
                    None,
                ),
                (
                    "view3d.view_lock_clear",
                    {"type": "NUMPAD_PERIOD", "value": "PRESS", "alt": True},
                    None,
                ),
                (
                    "view3d.navigate",
                ...
                (
                    ...
                    {"type": "COMMA", "value": "PRESS", "alt": True},
                    {
                        "properties": [
                            (
                                "data_path",
                                "tool_settings.use_transform_pivot_point_align",
                            )
                        ]
                    },
                ),
    ...
    items.extend(
        [
            ...
            (
                ...
                {
                    "type": params.select_mouse,
                    "value": "PRESS" if params.legacy else "CLICK",
                    "ctrl": True,
                },
            ...
            *_template_items_select_actions(params, "graph.select_all"),
            ...
            (
                "graph.select_box",
                {"type": params.select_mouse, "value": "CLICK_DRAG", "shift": True},
                {"properties": [("tweak", True), ("mode", "ADD")]},
            ),
            (
                "graph.select_box",
                {"type": params.select_mouse, "value": "CLICK_DRAG", "ctrl": True},
                {"properties": [("tweak", True), ("mode", "SUB")]},
            ),
            (
                "graph.select_lasso",
            ...
            (
                op_menu_pie(
                    "GRAPH_MT_snap_pie", {"type": "S", "value": "PRESS", "shift": True}
                )
                if not params.legacy
                else (
                    "graph.snap",
            ...
            (
                "graph.click_insert",
                {"type": params.action_mouse, "value": "CLICK", "ctrl": True},
                None,
            ),
            (
                "graph.click_insert",
            ...
            op_menu_pie(
                "GRAPH_MT_view_pie", {"type": "ACCENT_GRAVE", "value": "PRESS"}
            ),
            (
                "graph.fmodifier_add",
            ...
            *_template_items_proportional_editing(
                params,
                connected=False,
                toggle_data_path="tool_settings.use_proportional_fcurve",
            ),
            ("marker.add", {"type": "M", "value": "PRESS"}, None),
            *_template_items_context_menu(
                "GRAPH_MT_context_menu", params.context_menu_event
            ),
        ]
    )
    ...
    items.extend(
        [
            *_template_space_region_type_toggle(
            ...
            op_menu_pie(
                "IMAGE_MT_view_pie", {"type": "ACCENT_GRAVE", "value": "PRESS"}
            ),
        ]
    )
    ...
    items.extend(
        [
            ...
            (
                ...
                {"type": params.action_mouse, "value": "PRESS", "ctrl": True},
                {"properties": [("point", "BLACK_POINT")]},
            ),
            (
                "image.curves_point_set",
                {"type": params.action_mouse, "value": "PRESS", "shift": True},
                    ...
                    (
                        ...
                        {"type": NUMBERS_1[i], "value": "PRESS"},
                        {
                            "properties": [
                                (
                                    "data_path",
                                    "space_data.image.render_slots.active_index",
                                ),
                                ("value", i),
                            ]
                        },
            ...
            *_template_items_context_menu(
                "IMAGE_MT_mask_context_menu", params.context_menu_event
            ),
        ]
    )
    ...
    items.extend(
        [
            ...
            (
                "node.add_reroute",
                {
                    "type": "LEFTMOUSE" if params.legacy else "RIGHTMOUSE",
                    "value": "CLICK_DRAG",
                    "shift": True,
                },
                None,
            ...
            (
                ...
                {"type": params.action_mouse, "value": "PRESS", "alt": True},
                None,
            ),
            (
                "node.link_make",
            ...
            *_template_items_context_menu(
                "NODE_MT_context_menu", params.context_menu_event
            ),
        ]
    )
...
def km_info(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_menu(
                "INFO_MT_context_menu", params.context_menu_event
            ),
        ]
    )
    ...
    items.extend(
        [
            *_template_space_region_type_toggle(
            ...
            op_menu_pie(
                "FILEBROWSER_MT_view_pie", {"type": "ACCENT_GRAVE", "value": "PRESS"}
            ),
            ...
            *_template_items_context_menu(
                "FILEBROWSER_MT_context_menu", params.context_menu_event
            ),
        ]
    )
    ...
    items.extend(
        [
            ...
            (
                ...
                {
                    "properties": [
                        ("open", params.use_file_single_click),
                        ("deselect_all", not params.legacy),
                    ]
                },
            ),
            ...
            *_template_items_context_menu(
                "ASSETBROWSER_MT_context_menu", params.context_menu_event
            ),
        ]
    )
    ...
    items.extend(
        [
            ...
            *_template_items_select_actions(params, "action.select_all"),
            ...
            op_menu_pie(
                "DOPESHEET_MT_view_pie", {"type": "ACCENT_GRAVE", "value": "PRESS"}
            ),
            ("anim.channels_editable_toggle", {"type": "TAB", "value": "PRESS"}, None),
            (
                "anim.channels_select_filter",
            ...
            *_template_items_proportional_editing(
                params,
                connected=False,
                toggle_data_path="tool_settings.use_proportional_action",
            ),
            ("marker.add", {"type": "M", "value": "PRESS"}, None),
            ("marker.camera_bind", {"type": "B", "value": "PRESS", "ctrl": True}, None),
            *_template_items_context_menu(
                "DOPESHEET_MT_context_menu", params.context_menu_event
            ),
...
def km_nla_channels(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_menu(
                "NLA_MT_channel_context_menu", params.context_menu_event
            ),
        ]
    )
    ...
    items.extend(
        [
            ...
            *_template_items_select_actions(params, "nla.select_all"),
            ...
            (
                op_menu_pie(
                    "NLA_MT_snap_pie", {"type": "S", "value": "PRESS", "shift": True}
                )
                if not params.legacy
                else ("nla.snap", {"type": "S", "value": "PRESS", "shift": True}, None)
            ),
            (
                "nla.fmodifier_add",
                {"type": "M", "value": "PRESS", "shift": True, "ctrl": True},
            ...
            ("marker.add", {"type": "M", "value": "PRESS"}, None),
            *_template_items_context_menu(
                "NLA_MT_context_menu", params.context_menu_event
            ),
            *_template_items_change_frame(params),
        ]
    )
    ...
    items.extend(
        [
            ...
            *_template_sequencer_timeline_select(
            ...
            op_menu_pie(
                "SEQUENCER_MT_view_pie", {"type": "ACCENT_GRAVE", "value": "PRESS"}
            ),
            ...
            *_template_items_context_menu(
                "SEQUENCER_MT_context_menu", params.context_menu_event
            ),
        ]
    )
    ...
    items.extend(
        [
            ...
            *_template_items_select_actions(params, "sequencer.select_all"),
            ...
            ("sequencer.delete", {"type": "DEL", "value": "PRESS"}, None),
            *_template_items_context_menu(
                "SEQUENCER_MT_preview_context_menu", params.context_menu_event
            ),
        ]
    )
    ...
    if not params.legacy:
        ...
        items.extend(
            [
                ...
                op_menu_pie(
                    "SEQUENCER_MT_pivot_pie", {"type": "PERIOD", "value": "PRESS"}
                ),
                (
                    "wm.context_toggle",
                    {"type": "Z", "value": "PRESS", "alt": True, "shift": True},
    ...
    items.extend(
        [
            *_template_space_region_type_toggle(
            ...
            op_menu_pie(
                "CLIP_MT_solving_pie", {"type": "S", "value": "PRESS", "shift": True}
            ),
            op_menu_pie(
                "CLIP_MT_marker_pie", {"type": "E", "value": "PRESS", "shift": True}
            ),
            op_menu_pie(
...
def km_clip_editor(params):
    ...
    items.extend(
        [
            ...
            *_template_items_hide_reveal_actions(
                "clip.hide_tracks", "clip.hide_tracks_clear"
            ),
            (
            ...
            *_template_items_context_menu(
                "CLIP_MT_tracking_context_menu", params.context_menu_event
            ),
        ]
    )
    ...
    items.extend(
        [
            ...
            *_template_items_select_actions(params, "anim.channels_select_all"),
            ...
            # Menus.
            *_template_items_context_menu(
                "DOPESHEET_MT_channel_context_menu", params.context_menu_event
            ),
            # View
            (
                "anim.channel_view_pick",
                {"type": "MIDDLEMOUSE", "value": "PRESS", "alt": True},
                None,
            ),
            (
    ...
    items.extend(
        [
            ...
            op_tool_optional(
                ...
                (op_tool_cycle, "builtin.interpolate"),
                params,
            ),
            (
            ...
            *_grease_pencil_selection(params),
            ...
            (
                ...
                if not params.legacy
                    ...
                    "GPENCIL_MT_snap", {"type": "S", "value": "PRESS", "shift": True}
                )
            ),
            # Show/hide
            ...
            *(
            ...
            # Context menu
            *_template_items_context_menu(
                "VIEW3D_MT_gpencil_edit_context_menu", params.context_menu_event
            ),
        ]
    )
    ...
    items.extend(
        [
            ...
            *_template_items_context_panel(
                "VIEW3D_PT_gpencil_draw_context_menu", params.context_menu_event
            ),
        ]
    )
...
def km_grease_pencil_stroke_sculpt_mode(params):
    ...
    items.extend(
        [
            # Selection
            *_grease_pencil_selection(
                params,
                use_select_mouse=(params.use_fallback_tool_select_mouse is False),
            ),
            # Brush strength
            (
                "wm.radial_control",
            ...
            *_grease_pencil_display(),
            ...
            # Context menu
            *_template_items_context_panel(
                "VIEW3D_PT_gpencil_sculpt_context_menu", params.context_menu_event
            ),
    ...
    items.extend(
        [
            ...
            *_grease_pencil_display(),
            ...
            # Context menu
            *_template_items_context_panel(
                "VIEW3D_PT_gpencil_weight_context_menu", params.context_menu_event
            ),
        ]
    )
    ...
    items.extend(
        [
            ...
            *_grease_pencil_display(),
            ...
            op_panel(
                "VIEW3D_PT_gpencil_vertex_context_menu", params.context_menu_event
            ),
        ]
    )
...
def km_face_mask(params):
    ...
    items.extend(
        [
            ...
            *_template_items_hide_reveal_actions(
                "paint.face_select_hide", "paint.face_vert_reveal"
            ),
            (
...
def km_weight_paint_vertex_selection(params):
    ...
    items.extend(
        [
            ...
            *_template_items_hide_reveal_actions(
                "paint.vert_select_hide", "paint.face_vert_reveal"
            ),
            ("view3d.select_box", {"type": "B", "value": "PRESS"}, None),
            (
                "view3d.select_lasso",
    ...
    items.extend(
        [
            ...
            *_template_items_hide_reveal_actions("pose.hide", "pose.reveal"),
            op_menu(
                "VIEW3D_MT_pose_apply", {"type": "A", "value": "PRESS", "ctrl": True}
            ),
            ...
            *_template_items_select_actions(params, "pose.select_all"),
            ...
            op_menu(
                "VIEW3D_MT_pose_group", {"type": "G", "value": "PRESS", "ctrl": True}
            ),
            op_menu(
            ...
            op_menu(
                "VIEW3D_MT_pose_propagate", {"type": "P", "value": "PRESS", "alt": True}
            ),
            *_template_object_hide_collection_from_number_keys(),
            *_template_items_context_menu(
                "VIEW3D_MT_pose_context_menu", params.context_menu_event
            ),
        ]
    )
    ...
    items.extend(
        [
            ...
            *_template_items_select_actions(params, "object.select_all"),
            ...
            op_menu(
                "VIEW3D_MT_object_apply", {"type": "A", "value": "PRESS", "ctrl": True}
            ),
            op_menu(
                "VIEW3D_MT_make_links", {"type": "L", "value": "PRESS", "ctrl": True}
            ),
            (
            ...
            *_template_items_hide_reveal_actions(
                "object.hide_view_set", "object.hide_view_clear"
            ),
            (
                "object.hide_collection",
                {"type": "H", "value": "PRESS", "ctrl": True},
            ...
            *_template_object_hide_collection_from_number_keys(),
            *_template_items_context_menu(
                "VIEW3D_MT_object_context_menu", params.context_menu_event
            ),
        ]
    )
...
def km_curve(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_menu(
                "VIEW3D_MT_edit_curve_context_menu", params.context_menu_event
            ),
        ]
    )
...
def _template_view3d_select(
    *, type, value, legacy, select_passthrough, exclude_mod=None
):
    ...
    items = [
        ...
        for props, mods in (
            (
                (
                    ("deselect_all", "select_passthrough", *props_vert_without_handles)
                    if select_passthrough
                    else ("deselect_all", *props_vert_without_handles)
                )
                if not legacy
                else (),
                (),
    ...
    if select_passthrough:
        ...
        items.append(
            (
                ...
                {
                    "properties": [
                        (c, True) for c in ("deselect_all", *props_vert_without_handles)
                    ]
                },
            )
        )
...
def _template_view3d_gpencil_select(*, type, value, legacy, use_select_mouse=True):
    return [
        *(
        ...
        (
            "gpencil.select",
            {"type": type, "value": value, "alt": True},
    ...
    items = [
        (
            ...
            {"type": type, "value": value},
            {
                "properties": [
                    ("deselect_all", True),
                    ("select_passthrough", select_passthrough),
                ]
            },
        ),
...
def km_image_paint(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_panel(
                "VIEW3D_PT_paint_texture_context_menu", params.context_menu_event
            ),
        ]
    )
...
def km_vertex_paint(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_panel(
                "VIEW3D_PT_paint_vertex_context_menu", params.context_menu_event
            ),
        ]
    )
        ...
        [
            ...
            *_template_paint_radial_control("weight_paint"),
            (
                ...
                {"type": "F", "value": "PRESS", "ctrl": True},
                radial_control_properties(
                    "weight_paint", "weight", "use_unified_weight"
                ),
            ),
            (
                "wm.context_menu_enum",
            ...
            op_menu_pie(
                "VIEW3D_MT_wpaint_vgroup_lock_pie", {"type": "K", "value": "PRESS"}
            ),
            (
                "paint.face_vert_reveal",
                {"type": "H", "value": "PRESS", "alt": True},
            ...
            *_template_items_context_panel(
                "VIEW3D_PT_paint_weight_context_menu", params.context_menu_event
            ),
        ]
    )
    ...
    items.extend(
        [
            ...
            *_template_paint_radial_control("sculpt", rotation=True),
            ...
            op_menu_pie(
                "VIEW3D_MT_sculpt_mask_edit_pie", {"type": "A", "value": "PRESS"}
            ),
            op_menu_pie(
            ...
            op_menu_pie(
                "VIEW3D_MT_sculpt_face_sets_edit_pie", {"type": "W", "value": "PRESS"}
            ),
            *_template_items_context_panel(
                "VIEW3D_PT_sculpt_context_menu", params.context_menu_event
            ),
        ]
    )
    ...
    items.extend(
        [
            ...
            op_tool_optional(
                ...
                (op_tool_cycle, "builtin.loop_cut"),
                params,
            ),
            op_tool_optional(
                (
                ...
                (op_tool_cycle, "builtin.offset_edge_loop_cut"),
                params,
            ),
            op_tool_optional(
                ("mesh.inset", {"type": "I", "value": "PRESS"}, None),
                (op_tool_cycle, "builtin.inset_faces"),
                params,
            ),
            op_tool_optional(
                (
            ...
            op_tool_optional(
                ...
                (op_tool_cycle, "builtin.shrink_fatten"),
                params,
            ),
            (
                "mesh.bevel",
            ...
            *_template_items_hide_reveal_actions("mesh.hide", "mesh.reveal"),
            ...
            op_tool_optional(
                ...
                (op_tool_cycle, "builtin.extrude_region"),
                params,
            ),
            op_menu(
            ...
            op_tool_optional(
                ...
                (op_tool_cycle, "builtin.rip_region"),
                params,
            ),
            ...
            op_menu(
                "VIEW3D_MT_mesh_add", {"type": "A", "value": "PRESS", "shift": True}
            ),
            ...
            op_tool_optional(
                ...
                (op_tool_cycle, "builtin.vertex_slide"),
                params,
            ),
            (
            ...
            op_menu(
                "VIEW3D_MT_vertex_group", {"type": "G", "value": "PRESS", "ctrl": True}
            ),
            op_menu(
            ...
            *_template_items_context_menu(
                "VIEW3D_MT_edit_mesh_context_menu", params.context_menu_event
            ),
        ]
    )
        ...
        [
            ...
            *_template_items_select_actions(params, "armature.select_all"),
            ...
            op_tool_optional(
                ...
                (op_tool_cycle, "builtin.bone_size"),
                params,
            ),
            op_tool_optional(
                (
                ...
                (op_tool_cycle, "builtin.bone_envelope"),
                params,
            ),
            op_tool_optional(
                (
                ...
                (op_tool_cycle, "builtin.roll"),
                params,
            ),
            # Menus.
            *_template_items_context_menu(
                "VIEW3D_MT_armature_context_menu", params.context_menu_event
            ),
        ]
    )
...
def km_metaball(params):
    ...
    items.extend(
        [
            ...
            *_template_items_hide_reveal_actions(
                "mball.hide_metaelems", "mball.reveal_metaelems"
            ),
            ...
            *_template_items_context_menu(
                "VIEW3D_MT_edit_metaball_context_menu", params.context_menu_event
            ),
        ]
    )
...
def km_lattice(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_menu(
                "VIEW3D_MT_edit_lattice_context_menu", params.context_menu_event
            ),
        ]
    )
...
def km_particle(params):
    ...
    items.extend(
        [
                    ...
                    (
                        ...
                        {"type": NUMBERS_1[i], "value": "PRESS"},
                        {
                            "properties": [
                                (
                                    "data_path",
                                    "tool_settings.particle_edit.select_mode",
                                ),
                                ("value", value),
                            ]
                        },
            ...
            *_template_items_context_menu(
                "VIEW3D_MT_particle_context_menu", params.context_menu_event
            ),
        ]
    )
...
def km_font(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_menu(
                "VIEW3D_MT_edit_font_context_menu", params.context_menu_event
            ),
        ]
    )
        ...
        if params.use_pie_click_drag:
            ...
            items.extend(
                [
                    ...
                    op_menu_pie(
                        "VIEW3D_MT_object_mode_pie", {"type": "TAB", "value": "PRESS"}
                    ),
                ]
            )
        else:
...
def km_sculpt_expand_modal(_params):
    ...
    items.extend(
        [
            ...
            *(
                (e, {"type": NUMBERS_1[i], "value": "PRESS", "any": True}, None)
            ...
            *(
                (
                    e,
                    {"type": "NUMPAD_%i" % (i + 1), "value": "PRESS", "any": True},
                    None,
                )
                for i, e in enumerate(
                    (
...
def km_generic_gizmo_maybe_drag(params):
    keymap = (
        ...
        {"space_type": "EMPTY", "region_type": "WINDOW"},
        {
            ...
            else _template_items_gizmo_tweak_value()
        },
    )
        ...
        {"space_type": "IMAGE_EDITOR", "region_type": "WINDOW"},
        {
            "items": [
                ...
                *(
                    ...
                    if (
                        not (
                            params.use_fallback_tool
                            and params.select_mouse == "RIGHTMOUSE"
                        )
                    )
                    else _template_uv_select(
                        type=params.select_mouse,
                        value=params.select_mouse_value,
                        select_passthrough=params.use_tweak_select_passthrough,
                        legacy=params.legacy,
    ...
    return (
        ...
        {"space_type": "IMAGE_EDITOR", "region_type": "WINDOW"},
        {
            "items": [
                *(
                    []
                    if (fallback and not params.use_fallback_tool)
                    else _template_items_tool_select_actions_simple(
                        "uv.select_box",
                        # Don't use `tool_maybe_tweak_event`, see comment for this slot.
                        **(
                            params.select_tweak_event
                            if (fallback and params.use_fallback_tool_select_mouse)
                            else params.tool_tweak_event
                        ),
                    )
                ),
            ]
                ...
                *(
                    ...
                    if (fallback and not params.use_fallback_tool)
                        ...
                        **(
                            params.select_tweak_event
                            if (fallback and params.use_fallback_tool_select_mouse)
                            else {"type": params.tool_mouse, "value": "PRESS"}
                        ),
                        properties=[("wait_for_input", False)],
                    )
                ),
        ...
        {"space_type": "NODE_EDITOR", "region_type": "WINDOW"},
        {
            "items": [
                ...
                *(
                    []
                    if (params.select_mouse == "RIGHTMOUSE")
                    else _template_node_select(
                        type=params.select_mouse, value="PRESS", select_passthrough=True
                    )
                ),
            ]
        },
        ...
        {"space_type": "VIEW_3D", "region_type": "WINDOW"},
        {
            "items": [
                *(
                    []
                    if (fallback and not params.use_fallback_tool)
                    else _template_items_tool_select_actions(
                        "view3d.select_box",
                        # Don't use `tool_maybe_tweak_event`, see comment for this slot.
                        **(
                            params.select_tweak_event
            ...
            "items": [
                (
                    "view3d.interactive_add",
                    {
                        ...
                        **(
                            {"any": True}
                            if "alt" in params.tool_modifier
                            else any_except("alt")
                        ),
                    },
                    {"properties": [("wait_for_input", False)]},
        ...
        {"space_type": "VIEW_3D", "region_type": "WINDOW"},
        {
            "items": [
                (
                    ...
                    {
                        "properties": [
                            ("TRANSFORM_OT_shrink_fatten", [("release_confirm", True)])
                        ]
                    },
                ),
            ]
        ...
        {"space_type": "VIEW_3D", "region_type": "WINDOW"},
        {
            "items": [
                ...
                (
                    ...
                    {
                        "properties": [
                            ("TRANSFORM_OT_edge_slide", [("release_confirm", True)])
                        ]
                    },
                ),
            ]
        ...
        {"space_type": "VIEW_3D", "region_type": "WINDOW"},
        {
            "items": [
                ...
                (
                    ...
                    {"type": params.tool_mouse, "value": "CLICK", "shift": True},
                    None,
                ),
            ]
        },
    ...
    return (
        ...
        {"space_type": "VIEW_3D", "region_type": "WINDOW"},
        {
            "items": [
                ...
                (
                    "curve.pen",
                    {"type": params.tool_mouse, "value": "DOUBLE_CLICK"},
                    {
                        "properties": [
                            ("toggle_vector", True),
        ...
        {"space_type": "VIEW_3D", "region_type": "WINDOW"},
        {
            "items": [
                ...
                *(
                    ...
                    else _template_view3d_gpencil_select(
                        type=params.select_mouse,
                        value=params.select_mouse_value,
                        legacy=params.legacy,
                    )
    ...
    return (
        ...
        {"space_type": "VIEW_3D", "region_type": "WINDOW"},
        {
            "items": _template_items_tool_select(
                params, "gpencil.select", "view3d.cursor3d"
            )
        },
    )
...
def km_3d_view_tool_sculpt_gpencil_select_box(params):
    return (
        ...
        {"space_type": "VIEW_3D", "region_type": "WINDOW"},
        {
            "items": _template_items_tool_select_actions(
                "gpencil.select_box", **params.tool_tweak_event
            )
        },
    )
...
def km_3d_view_tool_sculpt_gpencil_select_lasso(params):
    return (
        ...
        {
            "items": _template_items_tool_select_actions(
                "gpencil.select_lasso", **params.tool_tweak_event
            )
        },
    )
        ...
        {"space_type": "SEQUENCE_EDITOR", "region_type": "WINDOW"},
        {
            "items": [
                ...
                *(
                    ...
                    else _template_sequencer_preview_select(
                        type=params.select_mouse,
                        value=params.select_mouse_value,
                        legacy=params.legacy,
                    )
...
def generate_keymaps(params=None):
    ...
    return [
        ...
        *(
            km_image_editor_tool_uv_select(params, fallback=fallback)
            for fallback in (False, True)
        ),
        *(
            km_image_editor_tool_uv_select_box(params, fallback=fallback)
            for fallback in (False, True)
        ),
        *(
            km_image_editor_tool_uv_select_circle(params, fallback=fallback)
            for fallback in (False, True)
        ),
        *(
            km_image_editor_tool_uv_select_lasso(params, fallback=fallback)
            for fallback in (False, True)
        ),
        ...
        *(
            km_node_editor_tool_select(params, fallback=fallback)
            for fallback in (False, True)
        ),
        *(
            km_node_editor_tool_select_box(params, fallback=fallback)
            for fallback in (False, True)
        ),
        *(
            km_node_editor_tool_select_lasso(params, fallback=fallback)
            for fallback in (False, True)
        ),
        *(
            km_node_editor_tool_select_circle(params, fallback=fallback)
            for fallback in (False, True)
        ),
        km_node_editor_tool_links_cut(params),
        km_3d_view_tool_cursor(params),
        *(
            km_3d_view_tool_select(params, fallback=fallback)
            for fallback in (False, True)
        ),
        *(
            km_3d_view_tool_select_box(params, fallback=fallback)
            for fallback in (False, True)
        ),
        *(
            km_3d_view_tool_select_circle(params, fallback=fallback)
            for fallback in (False, True)
        ),
        *(
            km_3d_view_tool_select_lasso(params, fallback=fallback)
            for fallback in (False, True)
        ),
        ...
        *(
            km_3d_view_tool_edit_gpencil_select(params, fallback=fallback)
            for fallback in (False, True)
        ),
        *(
            km_3d_view_tool_edit_gpencil_select_box(params, fallback=fallback)
            for fallback in (False, True)
        ),
        *(
            km_3d_view_tool_edit_gpencil_select_circle(params, fallback=fallback)
            for fallback in (False, True)
        ),
        *(
            km_3d_view_tool_edit_gpencil_select_lasso(params, fallback=fallback)
            for fallback in (False, True)
        ),
        ...
        *(
            km_sequencer_editor_tool_generic_select(params, fallback=fallback)
            for fallback in (False, True)
        ),
        *(
            km_sequencer_editor_tool_generic_select_box(params, fallback=fallback)
            for fallback in (False, True)
        ),

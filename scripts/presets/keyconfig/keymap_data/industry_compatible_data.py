...
def op_tool_cycle(tool, kmi_args):
    return (
        "wm.tool_set_by_id",
        kmi_args,
        {"properties": [("name", tool), ("cycle", True)]},
    )
...
def _template_items_tool_select_actions(operator, *, type, value):
    ...
    return [
        ...
        (operator, {**kmi_args, "shift": True}, {"properties": [("mode", "ADD")]}),
        (operator, {**kmi_args, "ctrl": True}, {"properties": [("mode", "SUB")]}),
        (
            operator,
            {**kmi_args, "shift": True, "ctrl": True},
            {"properties": [("mode", "AND")]},
        ),
    ]
...
def _template_items_tool_select_actions_simple(operator, *, type, value, properties=()):
    ...
    return [
        ...
        (operator, kmi_args, {"properties": [*properties]}),
        (
            operator,
            {**kmi_args, "shift": True},
...
def _template_items_editmode_mesh_select_mode(params):
    return [
        ...
        for key_expand, prop_expand in (
            ({}, ()),
            ({"ctrl": True}, (("use_expand", True),)),
        )
        for key_extend, prop_extend in (
            ({}, ()),
            ({"shift": True}, (("use_extend", True),)),
        )
...
def km_window(params):
    ...
    items.extend(
        [
            ...
            op_menu(
                "SCREEN_MT_user_menu", {"type": "TAB", "value": "PRESS", "shift": True}
            ),
            # NDOF settings
            op_panel(
...
def km_screen(params):
    ...
    items.extend(
        [
            ...
            (
                "ed.undo_history",
                {"type": "Z", "value": "PRESS", "alt": True, "ctrl": True},
                None,
            ),
            # Render
...
def km_outliner(params):
    ...
    items.extend(
        [
            ...
            op_menu(
                "OUTLINER_MT_context_menu", {"type": "RIGHTMOUSE", "value": "PRESS"}
            ),
            (
    ...
    items.extend(
        [
            ...
            *_template_items_editmode_mesh_select_mode(params),
            ...
            op_menu_pie(
                "IMAGE_MT_uvs_snap_pie", {"type": "X", "value": "PRESS", "shift": True}
            ),
            *_template_items_context_menu(
                "IMAGE_MT_uvs_context_menu", {"type": "RIGHTMOUSE", "value": "PRESS"}
            ),
            (
                "wm.context_toggle",
                {"type": "B", "value": "PRESS"},
    ...
    items.extend(
        [
            ...
            *(
            ...
            # Menus.
            op_menu_pie(
                "VIEW3D_MT_snap_pie", {"type": "X", "value": "PRESS", "shift": True}
            ),
            # Transform.
            ("transform.translate", {"type": "LEFTMOUSE", "value": "CLICK_DRAG"}, None),
            op_menu_pie("VIEW3D_MT_pivot_pie", {"type": "PERIOD", "value": "PRESS"}),
            op_menu_pie(
                "VIEW3D_MT_orientations_pie", {"type": "COMMA", "value": "PRESS"}
            ),
...
def km_graph_editor(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_menu(
                "GRAPH_MT_context_menu", {"type": "RIGHTMOUSE", "value": "PRESS"}
            ),
            (
            ...
            ("marker.add", {"type": "M", "value": "PRESS"}, None),
            op_menu_pie(
                "GRAPH_MT_snap_pie", {"type": "X", "value": "PRESS", "shift": True}
            ),
        ]
    )
...
def km_node_editor(params):
    ...
    items.extend(
        [
            ...
            (
                "node.add_reroute",
                {"type": params.action_mouse, "value": "CLICK_DRAG", "shift": True},
                None,
            ),
            (
                "node.links_cut",
                {"type": params.action_mouse, "value": "CLICK_DRAG", "ctrl": True},
                None,
            ),
            (
                "node.links_mute",
            ...
            *_template_items_context_menu(
                "NODE_MT_context_menu", {"type": "RIGHTMOUSE", "value": "PRESS"}
            ),
            (
                "node.link_make",
                {"type": "L", "value": "PRESS"},
...
def km_info(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_menu(
                "INFO_MT_context_menu", {"type": "RIGHTMOUSE", "value": "PRESS"}
            ),
        ]
    )
...
def km_file_browser(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_menu(
                "FILEBROWSER_MT_context_menu", {"type": "RIGHTMOUSE", "value": "PRESS"}
            ),
        ]
    )
...
def km_file_browser_main(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_menu(
                "ASSETBROWSER_MT_context_menu", {"type": "RIGHTMOUSE", "value": "PRESS"}
            ),
        ]
    )
    ...
    items.extend(
        [
            *_template_items_animation(),
            ...
            op_menu_pie(
                "DOPESHEET_MT_snap_pie", {"type": "X", "value": "PRESS", "shift": True}
            ),
            *_template_items_context_menu(
                "DOPESHEET_MT_context_menu", {"type": "RIGHTMOUSE", "value": "PRESS"}
            ),
...
def km_nla_channels(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_menu(
                "NLA_MT_channel_context_menu", {"type": "RIGHTMOUSE", "value": "PRESS"}
            ),
        ]
    )
...
def km_nla_editor(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_menu(
                "NLA_MT_context_menu", {"type": "RIGHTMOUSE", "value": "PRESS"}
            ),
            op_menu_pie(
                "NLA_MT_snap_pie", {"type": "X", "value": "PRESS", "shift": True}
            ),
            ("marker.add", {"type": "M", "value": "PRESS"}, None),
        ]
    )
...
def km_sequencer(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_menu(
                "SEQUENCER_MT_context_menu", {"type": "RIGHTMOUSE", "value": "PRESS"}
            ),
            ("marker.add", {"type": "M", "value": "PRESS"}, None),
            # Tools
            op_tool_cycle("builtin.select_box", {"type": "Q", "value": "PRESS"}),
...
def km_console(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_menu(
                "CONSOLE_MT_context_menu", {"type": "RIGHTMOUSE", "value": "PRESS"}
            ),
            (
                "console.insert",
                {"type": "TEXTINPUT", "value": "ANY", "any": True, "repeat": True},
...
def km_clip_editor(params):
    ...
    items.extend(
        [
            ...
            op_menu(
                "CLIP_MT_select_grouped", {"type": "G", "value": "PRESS", "shift": True}
            ),
            (
    ...
    items.extend(
        [
            ...
            *_template_items_context_menu(
            ...
            # Snap
            op_menu_pie(
                "GPENCIL_MT_snap_pie", {"type": "X", "value": "PRESS", "shift": True}
            ),
            # Show/hide
            ...
            *_template_items_basic_tools(),
            op_tool_cycle(
                "builtin.extrude", {"type": "E", "value": "PRESS", "ctrl": True}
            ),
            op_tool_cycle(
                "builtin.radius", {"type": "R", "value": "PRESS", "ctrl": True}
            ),
            op_tool_cycle(
                "builtin.bend", {"type": "B", "value": "PRESS", "ctrl": True}
            ),
        ]
    )
    ...
    items.extend(
        [
            ...
            *_template_items_context_panel(
            ...
            op_menu(
                "GPENCIL_MT_gpencil_draw_delete", {"type": "DEL", "value": "PRESS"}
            ),
            # Tools
...
def km_pose(params):
    ...
    items.extend(
        [
            ...
            *_template_items_context_menu(
                "VIEW3D_MT_pose_context_menu", {"type": "RIGHTMOUSE", "value": "PRESS"}
            ),
            # Tools
            op_tool_cycle("builtin.select_box", {"type": "Q", "value": "PRESS"}),
            op_tool_cycle("builtin.move", {"type": "W", "value": "PRESS"}),
...
def km_curve(params):
    ...
    items.extend(
        [
            ...
            op_menu(
                "VIEW3D_MT_edit_curve_delete", {"type": "BACK_SPACE", "value": "PRESS"}
            ),
...
def radial_control_properties(
    paint, prop, secondary_prop, secondary_rotation=False, color=False, zoom=False
):
    ...
    return {
        "properties": [
            ...
            (
                "data_path_secondary",
                unified_path + "." + prop if secondary_prop else "",
            ),
            (
                "use_secondary",
                unified_path + "." + secondary_prop if secondary_prop else "",
            ),
            ...
            (
                ...
                unified_path + ".use_unified_color" if color else "",
            ),
...
def _template_paint_radial_control(
    paint, rotation=False, secondary_rotation=False, color=False, zoom=False
):
    items = []
        ...
        items.extend(
            [
                (
                    ...
                    {"type": "F", "value": "PRESS", "ctrl": True},
                    radial_control_properties(
                        paint, "texture_slot.angle", None, color=color
                    ),
                ),
            ]
        )
            ...
            (
                ...
                {"type": "S", "value": "PRESS", "shift": True},
                {
                    "properties": [
                        (
                            "data_path",
                            "tool_settings.weight_paint.brush.use_smooth_stroke",
                        )
                    ]
                },
            ),
    ...
    items.extend(
        [
            ...
            *_template_items_editmode_mesh_select_mode(params),
            ...
            op_menu(
                "VIEW3D_MT_edit_mesh_delete", {"type": "BACK_SPACE", "value": "PRESS"}
            ),
            ...
            *_template_items_basic_tools(),
            op_tool_cycle(
                "builtin.bevel", {"type": "B", "value": "PRESS", "ctrl": True}
            ),
            op_tool_cycle("builtin.inset_faces", {"type": "I", "value": "PRESS"}),
            op_tool_cycle(
                "builtin.extrude_region", {"type": "E", "value": "PRESS", "ctrl": True}
            ),
            op_tool_cycle("builtin.knife", {"type": "K", "value": "PRESS"}),
            op_tool_cycle(
                "builtin.loop_cut", {"type": "C", "value": "PRESS", "alt": True}
            ),
        ]
    )
...
def km_armature(params):
    ...
    items.extend(
        [
            ...
            # Editing.
            op_menu(
                "VIEW3D_MT_edit_armature_delete", {"type": "DEL", "value": "PRESS"}
            ),
            op_menu(
...
def km_3d_view_tool_select(params):
    return (
        ...
        {"space_type": "VIEW_3D", "region_type": "WINDOW"},
        {
            "items": _template_items_tool_select(
                params, "view3d.select", extend="toggle"
            )
        },
    )
...
def km_3d_view_tool_edit_gpencil_select(params):
    return (
        ...
        {
            "items": _template_items_tool_select(
                params, "gpencil.select", extend="toggle"
            )
        },
    )
...
def _template_node_select(*, type, value, select_passthrough):
    items = [
        ...
        (
            "node.select",
            {"type": type, "value": value, "ctrl": True, "alt": True},
            None,
        ),
        (
            "node.select",
            {"type": type, "value": value, "shift": True},
            {"properties": [("toggle", True)]},
        ),
        (
            "node.select",
            {"type": type, "value": value, "shift": True, "ctrl": True},
            {"properties": [("toggle", True)]},
        ),
        (
            "node.select",
            {"type": type, "value": value, "shift": True, "alt": True},
            {"properties": [("toggle", True)]},
        ),
        (
            "node.select",
            {"type": type, "value": value, "shift": True, "ctrl": True, "alt": True},
            {"properties": [("toggle", True)]},
        ),
    ]
        ...
        {"space_type": "VIEW_3D", "region_type": "WINDOW"},
        {
            "items": [
                (
                    ...
                    {"type": params.tool_mouse, "value": "CLICK_DRAG"},
                    {"properties": [("wait_for_input", False)]},
                ),
                (
                    "view3d.interactive_add",
                    {"type": params.tool_mouse, "value": "CLICK_DRAG", "ctrl": True},
                    {"properties": [("wait_for_input", False)]},
                ),
            ]
        },

...
if(UNIX AND NOT APPLE)
  if(NOT (CMAKE_C_COMPILER_ID STREQUAL "GNU") OR NOT (CMAKE_C_COMPILER_VERSION MATCHES "${RELEASE_GCC_VERSION}.*"))
...
if(UNIX AND NOT APPLE)
  if(NOT (CMAKE_CXX_COMPILER_ID STREQUAL "GNU") OR NOT (CMAKE_CXX_COMPILER_VERSION MATCHES "${RELEASE_GCC_VERSION}.*"))
    message(STATUS "  NOTE: Official releases use GCC ${RELEASE_GCC_VERSION}")
  endif()
endif()
...
if(NOT APPLE)
  ...
  if(NOT HIP_FOUND)
    ...
    if(NOT HIP_VERSION MATCHES "${RELEASE_HIP_VERSION}.*")
      message(STATUS "  NOTE: Official releases use HIP ${RELEASE_HIP_VERSION}")
    endif()
  endif()
endif()

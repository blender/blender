                                             ...
                                             const uint32_t path_flag)
{
  ...
  switch (node.path_type) {
    case NODE_LP_camera:
      info = (path_flag & PATH_RAY_VISIBILITY_CAMERA) ? 1.0f : 0.0f;
      break;
    case NODE_LP_shadow:
      info = (path_flag & PATH_RAY_VISIBILITY_SHADOW) ? 1.0f : 0.0f;
      break;
    case NODE_LP_diffuse:
      info = (path_flag & PATH_RAY_VISIBILITY_DIFFUSE) ? 1.0f : 0.0f;
      break;
    case NODE_LP_glossy:
      info = (path_flag & PATH_RAY_VISIBILITY_GLOSSY) ? 1.0f : 0.0f;
      break;
    ...
    case NODE_LP_transmission:
      info = (path_flag & PATH_RAY_VISIBILITY_TRANSMIT) ? 1.0f : 0.0f;
      break;
    case NODE_LP_volume_scatter:
      info = (path_flag & PATH_RAY_VISIBILITY_VOLUME_SCATTER) ? 1.0f : 0.0f;
      break;
    ...
    case NODE_LP_ray_depth: {
      ...
      if (path_flag & (PATH_RAY_VISIBILITY_SHADOW | PATH_RAY_EMISSION)) {
        info += 1.0f;
      }
      break;
    }

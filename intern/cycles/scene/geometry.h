...
enum {
  ...
  ATTR_FLOAT_NEEDS_REALLOC = (1 << 13),
  ATTR_FLOAT2_NEEDS_REALLOC = (1 << 14),
  ATTR_FLOAT3_NEEDS_REALLOC = (1 << 15),
  ATTR_FLOAT4_NEEDS_REALLOC = (1 << 16),
  ATTR_UCHAR4_NEEDS_REALLOC = (1 << 17),
  ATTR_NORMAL_NEEDS_REALLOC = (1 << 18),
  ATTR_QUATERNION_NEEDS_REALLOC = (1 << 19),

 ...
 * can be used. */
/* TODO(sergey): Support on all platforms.
 * The tricky part is Metal, where pointers and references require explicit address space. What is
 * the address space of `this`? */
#if !defined(__KERNEL_GPU__)

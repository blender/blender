...
def main():
    tests = [
        ...
        SpecMeshTest(
            "Bevel Extrude Back",
            "testBevelExtrudeBack",
            "expectedBevelExtrudeBack",
            [OperatorSpecObjectMode("convert", {"target": "MESH"})],
        ),
        SpecMeshTest(
            "Bevel Extrude Front",
            "testBevelExtrudeFront",
            "expectedBevelExtrudeFront",
            [OperatorSpecObjectMode("convert", {"target": "MESH"})],
        ),
        SpecMeshTest(
            "Bevel Extrude Full",
            "testBevelExtrudeFull",
            "expectedBevelExtrudeFull",
            [OperatorSpecObjectMode("convert", {"target": "MESH"})],
        ),
        SpecMeshTest(
            "Bevel Extrude Half",
            "testBevelExtrudeHalf",
        ...
        SpecMeshTest(
            "Caps Object Bevel",
            "testCapsObjectBevel",
            "expectedCapsObjectBevel",
            [OperatorSpecObjectMode("convert", {"target": "MESH"})],
        ),
        SpecMeshTest(
            "Caps Profile Bevel",
            "testCapsProfileBevel",
            "expectedCapsProfileBevel",
            [OperatorSpecObjectMode("convert", {"target": "MESH"})],
        ),
        SpecMeshTest(
            "Caps Profile Bevel Half",
            "testCapsProfileBevelHalf",
            "expectedCapsProfileBevelHalf",
            [OperatorSpecObjectMode("convert", {"target": "MESH"})],
        ),
        SpecMeshTest(
            "Caps Profile Bevel Quarter",
            "testCapsProfileBevelQuarter",
            "expectedCapsProfileBevelQuarter",
            [OperatorSpecObjectMode("convert", {"target": "MESH"})],
        ),
        SpecMeshTest(
            "Caps Round Bevel",
            "testCapsRoundBevel",
            "expectedCapsRoundBevel",
            [OperatorSpecObjectMode("convert", {"target": "MESH"})],
        ),
        SpecMeshTest(
            "Caps Round Bevel Extrude",
            "testCapsRoundBevelExtrude",
            "expectedCapsRoundBevelExtrude",
            [OperatorSpecObjectMode("convert", {"target": "MESH"})],
        ),
        SpecMeshTest(
            "Caps Round Bevel Half",
            "testCapsRoundBevelHalf",
            "expectedCapsRoundBevelHalf",
            [OperatorSpecObjectMode("convert", {"target": "MESH"})],
        ),
        SpecMeshTest(
            "Caps Round Bevel Quarter",
            "testCapsRoundBevelQuarter",
            "expectedCapsRoundBevelQuarter",
            [OperatorSpecObjectMode("convert", {"target": "MESH"})],
        ),
        SpecMeshTest(
            "Extrude Back",

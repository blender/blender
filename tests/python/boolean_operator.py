...
def main():
    tests = [
        SpecMeshTest(
            "Cubecube_intersect_union",
            "Cubecube",
            "Cubecube_result_1",
            [
                OperatorSpecEditMode(
                    "intersect_boolean",
                    {"operation": "UNION", "solver": "FAST"},
                    "FACE",
                    {0, 1, 2, 3, 4, 5},
                )
            ],
        ...
        SpecMeshTest(
            "Cubecube_intersect_cut",
            "Cubecube",
            "Cubecube_result_4",
            [
                OperatorSpecEditMode(
                    "intersect",
                    {"separate_mode": "CUT", "solver": "FAST"},
                    "FACE",
                    {0, 1, 2, 3, 4, 5},
                )
            ],
        ...
        SpecMeshTest(
            "Cubecube_intersect_none",
            "Cubecube",
            "Cubecube_result_6",
            [
                OperatorSpecEditMode(
                    "intersect",
                    {"separate_mode": "NONE", "solver": "FAST"},
                    "FACE",
                    {0, 1, 2, 3, 4, 5},
                )
            ],
        ...
        SpecMeshTest(
            "Cubecube_intersect_select_none",
            "Cubecube",
            "Cubecube_result_7",
            [
                OperatorSpecEditMode(

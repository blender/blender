    ...
    tests = [
        ...
        SpecMeshTest(
            ...
            [
                OperatorSpecEditMode(
                    "bevel",
                    {"offset": 0.2, "segments": 2, "affect": "VERTICES"},
                    "VERT",
                    {3},
                )
            ],
        ...
        SpecMeshTest(
            ...
            [
                OperatorSpecEditMode(
                    "bevel",
                    {"offset": 0.2, "segments": 3, "affect": "VERTICES"},
                    "VERT",
                    {3},
                )
            ],
        ...
        SpecMeshTest(
            ...
            [
                OperatorSpecEditMode(
                    "bevel",
                    {"offset": 0.2, "harden_normals": True},
                    "EDGE",
                    {8},
                )
            ],
        ...
        SpecMeshTest(
            ...
            [
                OperatorSpecEditMode(
                    "bevel", {"offset": 0.2, "segments": 3}, "EDGE", {1, 7}
                )
            ],
        ),
    ]

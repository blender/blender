...
def cube_mask_first_modifier_list():
    generate_modifiers = [
        ...
        ModifierSpec(
            "boolean",
            "BOOLEAN",
            {"object": bpy.data.objects["testCubeMaskFirst_boolean"], "solver": "FAST"},
        ),
...
def cube_random_modifier_list():
    generate_modifiers = [
        ...
        ModifierSpec(
            "boolean",
            "BOOLEAN",
            {"object": bpy.data.objects["testCubeRandom_boolean"], "solver": "FAST"},
        ),
        ModifierSpec("solidify", "SOLIDIFY", {}),
        ModifierSpec("build", "BUILD", {"frame_start": 1, "frame_duration": 1}, 2),
        ModifierSpec("triangulate", "TRIANGULATE", {}),
...
def main():
    tests = [
        ...
        SpecMeshTest(
            "CubeMaskFirst",
            "testCubeMaskFirst",
            "expectedCubeMaskFirst",
            cube_mask_first_modifier_list(),
        ),
        SpecMeshTest(
            "CollapseDecimate",
            "testCollapseDecimate",
        ...
        SpecMeshTest(
            "UnsubdivideDecimate",
            "testUnsubdivideDecimate",
            "expectedUnsubdivideDecimate",
            [
                ModifierSpec(
                    "decimate",
                    "DECIMATE",
                    {"decimate_type": "UNSUBDIV", "iterations": 2},
                )
            ],
        ),
        # 5
        SpecMeshTest(
            "RadialBisectMirror",
            "testRadialBisectMirror",
            "expectedRadialBisectMirror",
            [
                ModifierSpec(
                    "mirror1", "MIRROR", {"use_bisect_axis": (True, False, False)}
                ),
                ModifierSpec(
                    "mirror2",
                    "MIRROR",
        ...
        SpecMeshTest(
            "T58411Mirror",
            "regressT58411Mirror",
            "expectedT58411Mirror",
            [
                ModifierSpec("mirror", "MIRROR", {}),
                ModifierSpec(
                    "bevel", "BEVEL", {"segments": 2, "limit_method": "WEIGHT"}
                ),
        ...
        SpecMeshTest(
            ...
            [
                ModifierSpec(
                    "mirror",
                    "MIRROR",
                    {"mirror_object": bpy.data.objects["testBasicScrewHelper"]},
                ),
                ModifierSpec(
                    "screw",
                    "SCREW",
        ...
        SpecMeshTest(
            ...
            [
                ModifierSpec(
                    "mirror",
                    "MIRROR",
                    {"mirror_object": bpy.data.objects["testObjectScrewHelper2"]},
                ),
                ModifierSpec(
                    "screw",
                    "SCREW",
                    {
                        "angle": math.radians(600),
                        "steps": 32,
                        "iterations": 1,
                        "use_object_screw_offset": True,
                        "use_normal_calculate": True,
                        "object": bpy.data.objects["testObjectScrewHelper1"],
                    },
                ),
            ],
        ),
        ...
        SpecMeshTest(
            ...
            [
                ...
                ModifierSpec(
                    "weld", "WELD", {"merge_threshold": 0.2, "vertex_group": "Group"}
                ),
            ],
        ),
        SpecMeshTest(
            ...
            [
                ...
                ModifierSpec(
                    "weld", "WELD", {"merge_threshold": 0.1, "vertex_group": "Group"}
                ),
            ],
        ),
        ############################################
        ...
        SpecMeshTest(
            ...
            [
                ModifierSpec(
                    ...
                    {
                        "fit_type": "FIT_CURVE",
                        "curve": bpy.data.objects["testCurveArrayHelper"],
        ...
        SpecMeshTest(
            ...
            [
                ModifierSpec(
                    "build", "BUILD", {"frame_start": 1, "frame_duration": 1}, 2
                )
            ],
        ),
        # 17
        ...
        SpecMeshTest(
            "ObjectOffsetMirror",
            "testObjectOffsetMirror",
            "expectedObjectOffsetMirror",
            [
                ModifierSpec(
                    "mirror",
                    "MIRROR",
        ...
        SpecMeshTest(
            "CubeSolidify",
            "testCubeSolidify",
            "expectedCubeSolidify",
            [ModifierSpec("solidify", "SOLIDIFY", {})],
        ),
        SpecMeshTest(
            "ComplexSolidify",
            "testComplexSolidify",
            "expectedComplexSolidify",
            [
                ModifierSpec(
                    "solidify",
                    "SOLIDIFY",
        ...
        SpecMeshTest(
            "T63063Solidify",
            "regressT63063Solidify",
            "expectedT63063Solidify",
            [ModifierSpec("solid", "SOLIDIFY", {"thickness": 0.1, "offset": 0.7})],
        ),
        SpecMeshTest(
            "T61979Solidify",
            "regressT61979Solidify",
            "expectedT61979Solidify",
            [
                ModifierSpec(
                    "solid",
                    "SOLIDIFY",
        ...
        SpecMeshTest(
            "MonkeySubsurf",
            "testMonkeySubsurf",
            "expectedMonkeySubsurf",
            [ModifierSpec("subsurf", "SUBSURF", {})],
        ),
        SpecMeshTest(
            "CatmullClarkSubdivisionSurface",
            "testCatmullClarkSubdivisionSurface",
            "expectedCatmullClarkSubdivisionSurface",
            [ModifierSpec("subdivision", "SUBSURF", {"levels": 2})],
        ),
        SpecMeshTest(
            "SimpleSubdivisionSurface",
            "testSimpleSubdivisionSurface",
            "expectedSimpleSubdivisionSurface",
            [
                ModifierSpec(
                    "subdivision",
                    "SUBSURF",
                    {"levels": 2, "subdivision_type": "SIMPLE"},
                )
            ],
        ),
        SpecMeshTest(
            "Crease2dSubdivisionSurface",
            "testCrease2dSubdivisionSurface",
            "expectedCrease2dSubdivisionSurface",
            [ModifierSpec("subdivision", "SUBSURF", {"levels": 2})],
        ),
        SpecMeshTest(
            "Crease3dSubdivisionSurface",
            "testCrease3dSubdivisionSurface",
            "expectedCrease3dSubdivisionSurface",
            [ModifierSpec("subdivision", "SUBSURF", {"levels": 2})],
        ),
        # 34
        SpecMeshTest(
            "SphereTriangulate",
            "testSphereTriangulate",
            "expectedSphereTriangulate",
            [ModifierSpec("triangulate", "TRIANGULATE", {})],
        ),
        SpecMeshTest(
            "MonkeyWireframe",
            "testMonkeyWireframe",
            "expectedMonkeyWireframe",
            [ModifierSpec("wireframe", "WIREFRAME", {})],
        ),
        ...
        SpecMeshTest(
            "MonkeyArmature",
            "testMonkeyArmature",
            "expectedMonkeyArmature",
            [
                ModifierSpec(
                    "armature",
                    "ARMATURE",
                    {
                        "object": bpy.data.objects["testArmature"],
        ...
        SpecMeshTest(
            ...
            [
                ModifierSpec(
                    "curve", "CURVE", {"object": bpy.data.objects["testBezierCurve"]}
                )
            ],
        ),
        SpecMeshTest(
        ...
        SpecMeshTest(
            ...
            [
                ModifierSpec(
                    "lattice", "LATTICE", {"object": bpy.data.objects["testLattice"]}
                )
            ],
        ),
        SpecMeshTest(
        ...
        SpecMeshTest(
            "CylinderSimpleDeform",
            "testCylinderSimpleDeform",
            "expectedCylinderSimpleDeform",
            [
                ModifierSpec(
                    "simple_deform",
                    "SIMPLE_DEFORM",
                    {"angle": math.radians(180), "deform_axis": "Z"},
                )
            ],
        ),
        SpecMeshTest(
        ...
        SpecMeshTest(
            "BalloonLaplacianSmooth",
            "testBalloonLaplacianSmooth",
            "expectedBalloonLaplacianSmooth",
            [
                ModifierSpec(
                    "laplaciansmooth",
                    "LAPLACIANSMOOTH",
                    {"lambda_factor": 12, "lambda_border": 12},
                )
            ],
        ),
        # Gets updated often
        ...
        SpecMeshTest(
            "BezCurveArray",
            "testObjBezierCurveArray",
            "expObjBezierCurveArray",
            [ModifierSpec("array", "ARRAY", {})],
        ),
        SpecMeshTest(
            "CurveBevel",
            "testObjBezierCurveBevel",
            "expObjBezierCurveBevel",
            [ModifierSpec("bevel", "BEVEL", {"limit_method": "NONE"})],
        ),
        SpecMeshTest(
            "CurveBuild",
            "testObjBezierCurveBuild",
        ...
        SpecMeshTest(
            "CurveDecimate",
            "testObjBezierCurveDecimate",
            "expObjBezierCurveDecimate",
            [ModifierSpec("decimate", "DECIMATE", {"ratio": 0.5})],
        ),
        SpecMeshTest(
            "CurveEdgeSplit",
            "testObjBezierCurveEdgeSplit",
            "expObjBezierCurveEdgeSplit",
            [ModifierSpec("edgeSplit", "EDGE_SPLIT", {})],
        ),
        SpecMeshTest(
            "CurveMirror",
            "testObjBezierCurveMirror",
            "expObjBezierCurveMirror",
            [ModifierSpec("mirror", "MIRROR", {"use_axis": (True, True, False)})],
        ),
        SpecMeshTest(
            "CurveScrew",
            "testObjBezierCurveScrew",
            "expObjBezierCurveScrew",
            [ModifierSpec("screw", "SCREW", {})],
        ),
        SpecMeshTest(
            "CurveSolidify",
            "testObjBezierCurveSolidify",
            "expObjBezierCurveSolidify",
            [ModifierSpec("solidify", "SOLIDIFY", {"thickness": 1})],
        ),
        SpecMeshTest(
            "CurveSubSurf",
            "testObjBezierCurveSubSurf",
            "expObjBezierCurveSubSurf",
            [ModifierSpec("subSurf", "SUBSURF", {})],
        ),
        SpecMeshTest(
            "CurveTriangulate",
            "testObjBezierCurveTriangulate",
            "expObjBezierCurveTriangulate",
            [ModifierSpec("triangulate", "TRIANGULATE", {})],
        ),
        # Test 60
        ...
        SpecMeshTest(
            "CurveWeld",
            "testObjBezierCurveWeld",
            "expObjBezierCurveWeld",
            [ModifierSpec("weld", "WELD", {})],
        ),
        SpecMeshTest(
            "CurveWeld2",
            "testObjBezierCurveWeld2",
            "expObjBezierCurveWeld2",
            [ModifierSpec("weld", "WELD", {})],
        ),
        #############################################
        ...
        SpecMeshTest(
            "CurveCast",
            "testObjBezierCurveCast",
            "expObjBezierCurveCast",
            [ModifierSpec("Cast", "CAST", {"cast_type": "CYLINDER", "factor": 10})],
        ),
        SpecMeshTest(
            "CurveShrinkWrap",
            "testObjBezierCurveShrinkWrap",
            "expObjBezierCurveShrinkWrap",
            [
                ModifierSpec(
                    "ShrinkWrap",
                    "SHRINKWRAP",
        ...
        SpecMeshTest(
            "CurveSimpleDeform",
            "testObjBezierCurveSimpleDeform",
            "expObjBezierCurveSimpleDeform",
            [
                ModifierSpec(
                    "simple_deform", "SIMPLE_DEFORM", {"angle": math.radians(90)}
                )
            ],
        ),
        SpecMeshTest(
            "CurveSmooth",
            "testObjBezierCurveSmooth",
            "expObjBezierCurveSmooth",
            [ModifierSpec("smooth", "SMOOTH", {"factor": 10})],
        ),
        SpecMeshTest(
            "CurveWave",
            "testObjBezierCurveWave",
            "expObjBezierCurveWave",
            [ModifierSpec("curve_wave", "WAVE", {"time_offset": -1.5})],
        ),
        SpecMeshTest(
            "CurveCurve",
            "testObjBezierCurveCurve",
            "expObjBezierCurveCurve",
            [
                ModifierSpec(
                    "curve_Curve", "CURVE", {"object": bpy.data.objects["NurbsCurve"]}
                )
            ],
        ),
    ]
                ...
                ModifierSpec(
                    ...
                    "BOOLEAN",
                    {
                        ...
                        "collection": bpy.data.collections[
                            "test" + boolean_basename + "Operands"
                        ],
                    },
                )
            ],

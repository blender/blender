...
def main():
    tests = [
        ...
        SpecMeshTest(
            ...
            [
                OperatorSpecEditMode(
                    "blend_from_shape", {"shape": "Key 1"}, "FACE", {0, 1, 2, 3, 4, 5}
                )
            ],
        ),
        # bridge edge loops
        ...
        SpecMeshTest(
            ...
            [OperatorSpecEditMode("decimate", {"ratio": 0.1}, "FACE", set(range(500)))],
        ),
        # delete
        SpecMeshTest(
            "CubeDeleteVertices",
        ...
        SpecMeshTest(
            ...
            [OperatorSpecEditMode("dissolve_degenerate", {}, "VERT", set(range(8)))],
        ),
        # dissolve edges
        SpecMeshTest(
            "CylinderDissolveEdges",
        ...
        SpecMeshTest(
            ...
            [
                OperatorSpecEditMode(
                    "dissolve_faces", {}, "VERT", {5, 34, 47, 49, 83, 91, 95}
                )
            ],
        ),
        # dissolve limited
        ...
        SpecMeshTest(
            ...
            [
                OperatorSpecEditMode(
                    "dissolve_mode", {"use_verts": True}, "FACE", {0, 1, 2, 10, 12, 13}
                )
            ],
        ),
        # dissolve verts
        ...
        SpecMeshTest(
            ...
            [OperatorSpecEditMode("duplicate", {}, "VERT", set(range(33)) - {23})],
        ),
        SpecMeshTest(
        ...
        SpecMeshTest(
            ...
            [OperatorSpecEditMode("duplicate", {}, "EDGE", set(range(64)))],
        ),
        # edge collapse
        SpecMeshTest(
        ...
        SpecMeshTest(
            ...
            [
                OperatorSpecEditMode(
                    "edge_split", {}, "EDGE", {2, 5, 8, 11, 14, 17, 20, 23}
                )
            ],
        ),
        ...
        SpecMeshTest(
            ...
            [
                OperatorSpecEditMode(
                    "edges_select_sharp", {"sharpness": 0.25}, "EDGE", {288}
                )
            ],
        ),
        SpecMeshTest(
            ...
            [
                OperatorSpecEditMode(
                    "edges_select_sharp", {"sharpness": 0.18}, "VERT", {}
                )
            ],
        ),
        SpecMeshTest(
        ...
        SpecMeshTest(
            ...
            [OperatorSpecEditMode("face_make_planar", {}, "FACE", set(range(500)))],
        ),
        # face split by edges
        SpecMeshTest(
            ...
            [OperatorSpecEditMode("face_split_by_edges", {}, "VERT", set(range(6)))],
        ),
        ...
        SpecMeshTest(
            ...
            [
                OperatorSpecEditMode(
                    "fill", {}, "EDGE", {20, 21, 22, 23, 24, 45, 46, 47, 48, 49}
                )
            ],
        ),
        SpecMeshTest(
        ...
        SpecMeshTest(
            ...
            [
                OperatorSpecEditMode(
                    "fill_grid", {}, "EDGE", {1, 2, 3, 4, 5, 7, 9, 10, 11, 12, 13, 15}
                )
            ],
        ),
        SpecMeshTest(
        ...
        SpecMeshTest(
            ...
            [OperatorSpecEditMode("fill_holes", {"sides": 9}, "VERT", set(range(481)))],
        ),
        ...
        SpecMeshTest(
            ...
            [OperatorSpecEditMode("faces_shade_smooth", {}, "VERT", set(range(8)))],
        ),
        ...
        SpecMeshTest(
            ...
            [OperatorSpecEditMode("faces_shade_flat", {}, "FACE", set(range(6)))],
        ),
        # hide
        SpecMeshTest(
            "HideFace",
        ...
        SpecMeshTest(
            ...
            [
                OperatorSpecEditMode(
                    "loop_multi_select", {}, "VERT", {355, 359, 73, 301, 302}
                )
            ],
        ),
        SpecMeshTest(
            ...
            [
                OperatorSpecEditMode(
                    "loop_multi_select", {}, "VERT", {257, 169, 202, 207, 274, 278, 63}
                )
            ],
        ),
        SpecMeshTest(
        ...
        SpecMeshTest(
            ...
            [
                OperatorSpecEditMode(
                    ...
                    {"number": 4, "type": "GREATER", "extend": True},
                    "FACE",
                    {},
                )
            ],
        ...
        SpecMeshTest(
            ...
            [OperatorSpecEditMode("select_nth", {}, "VERT", set(range(32)))],
        ),
        ...
        SpecMeshTest(
            ...
            [OperatorSpecEditMode("quads_convert_to_tris", {}, "FACE", set(range(6)))],
        ),
        # Tris to Quads
        SpecMeshTest(
            "TrisToQuads",
            "testPlanesTrisToQuad",
            "expectedPlanesTrisToQuad",
            [
                OperatorSpecEditMode(
        ...
        SpecMeshTest(
            ...
            [OperatorSpecEditMode("unsubdivide", {}, "FACE", set(range(6)))],
        ),
        # UV Manipulation
        SpecMeshTest(
            "UVRotate",
        ...
        SpecMeshTest(
            ...
            [OperatorSpecEditMode("unsubdivide", {}, "EDGE", set(range(6)))],
        ),
        SpecMeshTest(
            "UVSphereUnsubdivide",
            ...
            [
                OperatorSpecEditMode(
                    "unsubdivide", {"iterations": 9}, "FACE", set(range(512))
                )
            ],
        ),
        # vert connect path
        ...
        SpecMeshTest(
            ...
            [OperatorSpecEditMode("wireframe", {}, "FACE", set(range(6)))],
        ),
        SpecMeshTest(
            "WireFrameAlt",

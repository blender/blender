...
#define SNORM_8_8_8_8_(impl)            impl(char4_norm,   1 * 4,  4,    SNORM_8_8_8_8,       R8G8B8A8_SNORM,       RGBA8Snorm,       Char4Normalized,     RGBA8_SNORM,    rgba8_snorm)
/*                                           type          size    comps blender_enum         vk_enum               mtl_pixel_enum    mtl_vertex_enum      gl_pixel_enum   shader_enum  */
#define SNORM_16_(impl)                 impl(/*TODO*/,     2 * 1,  1,    SNORM_16,            R16_SNORM,            R16Snorm,         ShortNormalized,     R16_SNORM,      r16_snorm)
#define SNORM_16_16_(impl)              impl(short2_norm,  2 * 2,  2,    SNORM_16_16,         R16G16_SNORM,         RG16Snorm,        Short2Normalized,    RG16_SNORM,     rg16_snorm)
...
#define SNORM_16_16_16_16_(impl)        impl(short4_norm,  2 * 4,  4,    SNORM_16_16_16_16,   R16G16B16A16_SNORM,   RGBA16Snorm,      Short4Normalized,    RGBA16_SNORM,   rgba16_snorm)
/*                                           type          size    comps blender_enum         vk_enum               mtl_pixel_enum    mtl_vertex_enum      gl_pixel_enum   shader_enum  */
...
#define UNORM_8_8_8_8_(impl)            impl(uchar4_norm,  1 * 4,  4,    UNORM_8_8_8_8,       R8G8B8A8_UNORM,       RGBA8Unorm,       UChar4Normalized,    RGBA8,          rgba8_unorm)
/*                                           type          size    comps blender_enum         vk_enum               mtl_pixel_enum    mtl_vertex_enum      gl_pixel_enum   shader_enum  */
#define UNORM_16_(impl)                 impl(/*TODO*/,     2 * 1,  1,    UNORM_16,            R16_UNORM,            R16Unorm,         UShortNormalized,    R16,            r16_unorm)
#define UNORM_16_16_(impl)              impl(ushort2_norm, 2 * 2,  2,    UNORM_16_16,         R16G16_UNORM,         RG16Unorm,        UShort2Normalized,   RG16,           rg16_unorm)
...
#define UNORM_16_16_16_16_(impl)        impl(ushort4_norm, 2 * 4,  4,    UNORM_16_16_16_16,   R16G16B16A16_UNORM,   RGBA16Unorm,      UShort4Normalized,   RGBA16,         rgba16_unorm)
/*                                           type          size    comps blender_enum         vk_enum               mtl_pixel_enum    mtl_vertex_enum      gl_pixel_enum   shader_enum  */
...
/* clang-format off */
/*                                           type              size comps blender_enum            vk_enum                   mtl_pixel_enum         mtl_vertex_enum        gl_pixel_enum                        shader_enum  */
#define SNORM_10_10_10_2_(impl)         impl(int1010102_norm,  4,   4,    SNORM_10_10_10_2,       A2B10G10R10_SNORM_PACK32, /* n/a */,             Int1010102Normalized,  /* n/a */,                           /* n/a */       )
#define UNORM_10_10_10_2_(impl)         impl(uint1010102_norm, 4,   4,    UNORM_10_10_10_2,       A2B10G10R10_UNORM_PACK32, RGB10A2Unorm,          UInt1010102Normalized, RGB10_A2,                            rgb10_a2_unorm  )

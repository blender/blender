...
COMPUTE_SOURCE("eevee_test_shadow.bsl.hh")
...
COMPUTE_SOURCE("eevee_test_occupancy.bsl.hh")
TYPEDEF_SOURCE("eevee_defines.hh")
ADDITIONAL_INFO(gpu_shader_test)
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()
...
COMPUTE_SOURCE("eevee_test_gbuffer_normal.bsl.hh")
COMPUTE_FUNCTION("eevee_test_gbuffer_normal")
TYPEDEF_SOURCE("eevee_defines.hh")
ADDITIONAL_INFO(gpu_shader_test)
COMPILATION_CONSTANT(bool, gbuffer_has_reflection, true)
COMPILATION_CONSTANT(bool, gbuffer_has_refraction, true)
COMPILATION_CONSTANT(bool, gbuffer_has_subsurface, true)
COMPILATION_CONSTANT(bool, gbuffer_has_translucent, true)
COMPILATION_CONSTANT(bool, gbuffer_reflection_colorless, false)
COMPILATION_CONSTANT(bool, gbuffer_refraction_colorless, false)
COMPILATION_CONSTANT(int, gbuffer_layer_max, 3)
COMPILATION_CONSTANT(bool, gbuffer_simple_layout, false)
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()

GPU_SHADER_CREATE_INFO(eevee_gbuffer_closure_test)
COMPUTE_SOURCE("eevee_test_gbuffer_closure.bsl.hh")
COMPUTE_FUNCTION("eevee_test_gbuffer_closure")
TYPEDEF_SOURCE("eevee_defines.hh")
ADDITIONAL_INFO(gpu_shader_test)
COMPILATION_CONSTANT(bool, gbuffer_has_reflection, true)
COMPILATION_CONSTANT(bool, gbuffer_has_refraction, true)

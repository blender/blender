...
void jacobi_svd_2x2(float3x3 matrix, int p, int q, float2x2 &j_left, float2x2 &j_right)
{
  float2x2 block;
...
void jacobi_svd_3x3(float3x3 A, float3x3 &U, float3 &S, float3x3 &V)
{
...
[[node]]
void matrix_svd(float4x4 matrix, float4x4 &U, float3 &S, float4x4 &V)
{

...
[[node]]
void random_value_float(float min_value, float max_value, int id, int seed, float &result)
{
...
[[node]]
void random_value_int(int min_value, int max_value, int id, int seed, int &result)
{
...
[[node]]
void random_value_bool(float probability, int id, int seed, bool &result)
{

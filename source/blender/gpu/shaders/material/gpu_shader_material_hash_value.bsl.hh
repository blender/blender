...
[[node]]
void hash_value_float(float value, int seed, int &hash)
{
  hash = int(hash_uint2(hash_value_float_to_uint(value), uint(seed)));
}

[[node]]
void hash_value_vector(float3 value, int seed, int &hash)
{
  hash = int(hash_uint2(hash_value_vec3_to_uint(value), uint(seed)));
}

[[node]]
void hash_value_color(float4 value, int seed, int &hash)
{
  hash = int(hash_uint2(hash_value_vec4_to_uint(value), uint(seed)));
}

[[node]]
void hash_value_int(int value, int seed, int &hash)
{
  hash = int(hash_uint2(hash_uint(uint(value)), uint(seed)));
}

[[node]]
void hash_value_rotation(float4 value, int seed, int &hash)
{
  hash = int(hash_uint2(hash_value_vec4_to_uint(value), uint(seed)));
}

[[node]]
void hash_value_matrix(float4x4 value, int seed, int &hash)
{

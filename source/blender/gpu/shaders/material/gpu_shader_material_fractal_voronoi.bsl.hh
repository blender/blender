...
#include "gpu_shader_material_voronoi.bsl.hh"
 ...
 * by lerps. */
template<typename T> float fractal_voronoi_distance_to_edge(VoronoiParams params, T coord)
{
...
template float fractal_voronoi_distance_to_edge<float>(VoronoiParams params, float coord);
...
template float fractal_voronoi_distance_to_edge<float2>(VoronoiParams params, float2 coord);
...
template float fractal_voronoi_distance_to_edge<float3>(VoronoiParams params, float3 coord);
...
template float fractal_voronoi_distance_to_edge<float4>(VoronoiParams params, float4 coord);

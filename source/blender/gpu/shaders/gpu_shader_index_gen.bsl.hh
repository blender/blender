...
#define INDEX_GEN_GROUP_SIZE 16
 ...
 */
[[compute]] [[local_size(INDEX_GEN_GROUP_SIZE, INDEX_GEN_GROUP_SIZE, 1)]] void gen_points(
    [[resource_table]] const Resources &srt,
    [[global_invocation_id]] const uint3 global_id,
    [[num_work_groups]] const uint3 num_groups)
{
  int3 gid = int3(global_id);
  int3 nthreads = int3(num_groups * uint3(INDEX_GEN_GROUP_SIZE, INDEX_GEN_GROUP_SIZE, 1));
 ...
 */
[[compute]] [[local_size(INDEX_GEN_GROUP_SIZE, INDEX_GEN_GROUP_SIZE, 1)]] void gen_lines(
    [[resource_table]] const Resources &srt,
    [[global_invocation_id]] const uint3 global_id,
    [[num_work_groups]] const uint3 num_groups)
{
 ...
 *  primitives can't be used for some reason.
 */
[[compute]] [[local_size(INDEX_GEN_GROUP_SIZE, INDEX_GEN_GROUP_SIZE, 1)]] void gen_triangles(
    [[resource_table]] const Resources &srt,
    [[global_invocation_id]] const uint3 global_id,
    [[num_work_groups]] const uint3 num_groups)
{

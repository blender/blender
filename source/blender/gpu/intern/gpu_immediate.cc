...
{
  float color[4];
  blender::ui::UI_GetThemeColor4fv(color_id, color);
...
{
  float color[4];
  blender::ui::UI_GetThemeColor3fv(color_id, color);
  color[3] = a;
  immUniformColor4fv(color);
}
...
{
  float color[4];
  blender::ui::UI_GetThemeColorShade4fv(color_id, offset, color);
  immUniformColor4fv(color);
}
...
{
  float color[4];
  blender::ui::UI_GetThemeColorShadeAlpha4fv(color_id, color_offset, alpha_offset, color);
  immUniformColor4fv(color);
}
...
{
  float color[4];
  blender::ui::UI_GetThemeColorBlendShade4fv(color_id1, color_id2, fac, offset, color);
  immUniformColor4fv(color);
}
...
{
  uint8_t color[3];
  blender::ui::UI_GetThemeColorBlend3ubv(color_id1, color_id2, fac, color);
...
{
  uchar col[4];
  blender::ui::UI_GetThemeColorShadeAlpha4ubv(colorid, coloffset, alphaoffset, col);

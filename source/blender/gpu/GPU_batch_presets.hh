...
gpu::Batch *GPU_batch_preset_sphere(int lod) ATTR_WARN_UNUSED_RESULT;
gpu::Batch *GPU_batch_preset_sphere_wire(int lod) ATTR_WARN_UNUSED_RESULT;

/**
 * To be used with procedural placement inside shader.
 */
gpu::Batch *GPU_batch_preset_quad();
...
void gpu_batch_storage_buffer_register(gpu::StorageBuf *preset_buffer);

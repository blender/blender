                               ...
                               void *update_cb_data)
{
  ...
  int *fsets = (int *)CustomData_get_layer_named(&input_mesh->pdata, CD_PROP_INT32, ".sculpt_face_set");
                                     ...
                                     void *update_cb_data)
{
  ...
  int *fsets = (int *)CustomData_get_layer_named(&input_mesh->pdata, CD_SCULPT_FACE_SETS, ".sculpt_face_set");

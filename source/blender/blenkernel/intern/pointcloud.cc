                                 ...
                                 const int /*flag*/)
{
  ...
  pointcloud_dst->runtime = new bke::PointCloudRuntime();
  ...
  if (pointcloud_src->runtime->bake_materials) {
    pointcloud_dst->runtime->bake_materials = std::make_unique<bke::bake::BakeMaterialsList>(
...
void PointCloud::count_memory(MemoryCounter &memory) const
{

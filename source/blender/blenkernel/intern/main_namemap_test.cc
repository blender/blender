...
class BMainNameMapTest : public testing::Test {
 public:
...
TEST_F(BMainNameMapTest, global_map_uniqueness)
{
  ...
  Object *ob_1_lib_1 = static_cast<Object *>(BKE_id_new_in_lib(bmain, lib_1, ID_OB, "IDName"));
  EXPECT_STREQ(BKE_id_name(ob_1_lib_1->id), "IDName");

  Object *ob_2_lib_1 = static_cast<Object *>(BKE_id_new_in_lib(bmain, lib_1, ID_OB, "IDName"));
  EXPECT_STREQ(BKE_id_name(ob_2_lib_1->id), "IDName.001");

  Object *ob_1_lib_2 = static_cast<Object *>(BKE_id_new_in_lib(bmain, lib_2, ID_OB, "IDName"));
  EXPECT_STREQ(BKE_id_name(ob_1_lib_2->id), "IDName");

  Object *ob_2_lib_2 = static_cast<Object *>(BKE_id_new_in_lib(bmain, lib_2, ID_OB, "IDName"));
  EXPECT_STREQ(BKE_id_name(ob_2_lib_2->id), "IDName.001");

  Object *ob_3_lib_2 = static_cast<Object *>(BKE_id_new_in_lib(bmain, lib_2, ID_OB, "IDName.003"));

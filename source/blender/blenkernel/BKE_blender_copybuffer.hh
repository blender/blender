...
/**
 * Import data-blocks from the given .blend filepath (i.e. append them) into a new temporary
 * Main data-base. The caller is responsible for freeing the temporary main.
 *

 ...
 * clearing the liboverride data from given \a id. If NULL, caller is responsible to perform
 ...
 * cases.
 */
void BKE_lib_override_library_make_local(struct Main *bmain, struct ID *id);

...
enum eWM_EventFlag {
  ...
  /**
   * Event originates from native touchscreen gesture stream.
   */
  WM_EVENT_SOURCE_TOUCHSCREEN = (1 << 4),
  /**
   * Trackpad/touch gesture was generated by two fingers.
   */
  WM_EVENT_MULTITOUCH_TWO_FINGERS = (1 << 5),
};

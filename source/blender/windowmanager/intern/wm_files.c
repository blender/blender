...
static void save_file_forwardcompat_cancel_button(uiBlock *block, wmGenericCallback *post_action)
{
  uiBut *but = uiDefIconTextBut(
      block, UI_BTYPE_BUT, 0, 0, IFACE_("Cancel"), 0, 0, 0, UI_UNIT_Y, NULL, 0, 0, 0, 0, "");
...
static void save_file_forwardcompat_overwrite(bContext *C, void *arg_block, void *arg_data)
{
  ...
  WM_operator_name_call(C, "WM_OT_save_mainfile", WM_OP_EXEC_DEFAULT, operator_propptr_p, NULL);
...
{
  uiBut *but = uiDefIconTextBut(
      block, UI_BTYPE_BUT, 0, 0, IFACE_("Overwrite"), 0, 0, 0, UI_UNIT_Y, NULL, 0, 0, 0, 0, "");
...
static void save_file_forwardcompat_saveas(bContext *C, void *arg_block, void *UNUSED(arg_data))
{
  ...
  WM_operator_name_call(C, "WM_OT_save_as_mainfile", WM_OP_INVOKE_DEFAULT, NULL, NULL);
}

static void save_file_forwardcompat_saveas_button(uiBlock *block, wmGenericCallback *post_action)
{
  uiBut *but = uiDefIconTextBut(
      block, UI_BTYPE_BUT, 0, 0, IFACE_("Save As..."), 0, 0, 0, UI_UNIT_Y, NULL, 0, 0, 0, 0, "");
...
static uiBlock *block_create_save_file_forwardcompat_dialog(bContext *C,
                                                            ...
                                                            void *arg1)
{
  wmGenericCallback *post_action = arg1;
  Main *bmain = CTX_data_main(C);

 ...
 */
static std::string process_source(std::string source, gpu::shader::ShaderCreateInfo &info)
{
  std::string res_declarations;
  /* Insert resource declaration after types declaration. */
  res_declarations += "#ifdef CREATE_INFO_RES_PASS_OCIO_Display\n";
  res_declarations += "CREATE_INFO_RES_PASS_OCIO_Display\n";
  res_declarations += "#endif\n";
  res_declarations += "#ifdef CREATE_INFO_RES_BATCH_OCIO_Display\n";
  res_declarations += "CREATE_INFO_RES_BATCH_OCIO_Display\n";
  res_declarations += "#endif\n";
  res_declarations += "#ifdef CREATE_INFO_RES_GEOMETRY_OCIO_Display\n";
  res_declarations += "CREATE_INFO_RES_GEOMETRY_OCIO_Display\n";
  res_declarations += "#endif\n";
  res_declarations += "\n";

  source_comment_out_uniforms(source);
  source = res_declarations + GPU_shader_preprocess_source(source, info);

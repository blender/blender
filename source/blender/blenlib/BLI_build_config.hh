...
#  define OS_ZOS 1
#else
#  error Please add support for your platform in BLI_build_config.hh
#endif
...
#else
#  error Please add support for your compiler in BLI_build_config.hh
#endif
...
#  define ARCH_CPU_LITTLE_ENDIAN 1
#else
#  error Please add support for your architecture in BLI_build_config.hh
#endif

...
GPU_SHADER_CREATE_INFO(compositor_parallel_reduction_luminance_shared)
...
ADDITIONAL_INFO(compositor_parallel_reduction_luminance_shared)
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()
...
GPU_SHADER_CREATE_INFO(compositor_sum_squared_difference_color)
COMPUTE_FUNCTION("reduce_sum_squared_difference_color")
ADDITIONAL_INFO(compositor_parallel_reduction_shared)
ADDITIONAL_INFO(compositor_parallel_reduction_float4_shared)
ADDITIONAL_INFO(compositor_parallel_reduction_output_float4)
PUSH_CONSTANT(float4, subtrahend)
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()
...
GPU_SHADER_CREATE_INFO(compositor_minimum_float4)
COMPUTE_FUNCTION("reduce_minimum_float4")
ADDITIONAL_INFO(compositor_parallel_reduction_shared)
ADDITIONAL_INFO(compositor_parallel_reduction_float4_shared)
ADDITIONAL_INFO(compositor_parallel_reduction_output_float4)
DO_STATIC_COMPILATION()
...
GPU_SHADER_CREATE_INFO(compositor_maximum_float4)
COMPUTE_FUNCTION("reduce_maximum_float4")
ADDITIONAL_INFO(compositor_parallel_reduction_shared)
ADDITIONAL_INFO(compositor_parallel_reduction_float4_shared)
ADDITIONAL_INFO(compositor_parallel_reduction_output_float4)
DO_STATIC_COMPILATION()

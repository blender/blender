...
float3 whitepoint_from_temp_tint(const float temperature, const float tint)
{
   ...
   * table. */
  constexpr float inverse_temperatures[31] = {
      0.0f,   10.0f,  20.0f,  30.0f,  40.0f,  50.0f,  60.0f,  70.0f,  80.0f,  90.0f,  100.0f,
      125.0f, 150.0f, 175.0f, 200.0f, 225.0f, 250.0f, 275.0f, 300.0f, 325.0f, 350.0f, 375.0f,
      400.0f, 425.0f, 450.0f, 475.0f, 500.0f, 525.0f, 550.0f, 575.0f, 600.0f};

  constexpr float2 uv_coordinates[31] = {
      float2(0.18006f, 0.26352f), float2(0.18066f, 0.26589f), float2(0.18133f, 0.26846f),
      float2(0.18208f, 0.27119f), float2(0.18293f, 0.27407f), float2(0.18388f, 0.27709f),
      float2(0.18494f, 0.28021f), float2(0.18611f, 0.28342f), float2(0.18740f, 0.28668f),
      float2(0.18880f, 0.28997f), float2(0.19032f, 0.29326f), float2(0.19462f, 0.30141f),
      float2(0.19962f, 0.30921f), float2(0.20525f, 0.31647f), float2(0.21142f, 0.32312f),
      float2(0.21807f, 0.32909f), float2(0.22511f, 0.33439f), float2(0.23247f, 0.33904f),
      float2(0.24010f, 0.34308f), float2(0.24792f, 0.34655f), float2(0.25591f, 0.34951f),
      float2(0.26400f, 0.35200f), float2(0.27218f, 0.35407f), float2(0.28039f, 0.35577f),
      float2(0.28863f, 0.35714f), float2(0.29685f, 0.35823f), float2(0.30505f, 0.35907f),
      float2(0.31320f, 0.35968f), float2(0.32129f, 0.36011f), float2(0.32931f, 0.36038f),
      float2(0.33724f, 0.36051f)};

  constexpr float isotherm_parameters[31] = {
      -0.24341f, -0.25479f, -0.26876f, -0.28539f, -0.30470f, -0.32675f, -0.35156f, -0.37915f,
      -0.40955f, -0.44278f, -0.47888f, -0.58204f, -0.70471f, -0.84901f, -1.0182f,  -1.2168f,
      -1.4512f,  -1.7298f,  -2.0637f,  -2.4681f,  -2.9641f,  -3.5814f,  -4.3633f,  -5.3762f,

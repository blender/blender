...
{
  render_result_ = MEM_new_for_free<RenderResult>("Temporary Render Result For File Output");
  ...
  RenderLayer *render_layer = MEM_new_for_free<RenderLayer>("Render Layer For File Output.");
...
void FileOutput::add_view(const char *view_name)
{
  ...
  RenderView *render_view = MEM_new_for_free<RenderView>("Render View For File Output.");
                          ...
                          float *buffer)
{
  ...
  RenderPass *render_pass = MEM_new_for_free<RenderPass>("Render Pass For File Output.");

...
static void gizmo_mesh_bisect_setup(const bContext *C, wmGizmoGroup *gzgroup)
{
  ...
  blender::ui::UI_GetThemeColor3fv(TH_GIZMO_PRIMARY, ggd->translate_z->color);
  blender::ui::UI_GetThemeColor3fv(TH_GIZMO_PRIMARY, ggd->translate_c->color);
  blender::ui::UI_GetThemeColor3fv(TH_GIZMO_SECONDARY, ggd->rotate_c->color);

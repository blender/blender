                                           ...
                                           MutableSpan<float> sizes)
{
  ...
  ui::GetThemeColor4fv(TH_GIZMO_PRIMARY, color_gizmo_primary);
  ui::GetThemeColor4fv(TH_GIZMO_SECONDARY, color_gizmo_secondary);
  ui::GetThemeColor4fv(TH_GIZMO_A, color_gizmo_a);
  ui::GetThemeColor4fv(TH_GIZMO_B, color_gizmo_b);

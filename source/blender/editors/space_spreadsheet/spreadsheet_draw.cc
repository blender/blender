                                     ...
                                     const SpreadsheetDrawer &drawer)
{
  ...
  uiBlock *left_column_block = block_begin(C, region, __func__, ui::EmbossType::None);
                                 ...
                                 const int scroll_offset_x)
{
  ...
  uiBlock *first_row_block = block_begin(C, region, __func__, ui::EmbossType::None);
                               ...
                               const int scroll_offset_y)
{
  ...
  uiBlock *cells_block = block_begin(C, region, __func__, ui::EmbossType::None);

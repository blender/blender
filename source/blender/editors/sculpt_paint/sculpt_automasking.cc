...
static float automasking_view_occlusion_factor(AutomaskingCache *automasking,
                                               ...
                                               bool force = false)
{
  char f = *SCULPT_vertex_attr_get<char *>(vertex, ss->attrs.automasking_occlusion);

  if (force || SCULPT_stroke_id_test(ss, vertex, STROKEID_USER_OCCLUSION)) {
    f = *SCULPT_vertex_attr_get<char *>(
        vertex,
                                       ...
                                       PBVHVertRef vertex)
{
  ...
  *SCULPT_vertex_attr_get<float *>(vertex, ss->attrs.automasking_cavity) = factor_sum;
}
                                              ...
                                              PBVHVertRef vertex)
{
  ...
  float factor = *SCULPT_vertex_attr_get<float *>(vertex, ss->attrs.automasking_cavity);
                                    ...
                                    AutomaskingNodeData *automask_data)
{
  ...
  if (ss->attrs.automasking_factor) {
    float factor = *SCULPT_vertex_attr_get<float *>(vert, ss->attrs.automasking_factor);
    ...
    SculptSession *ss, PBVHVertRef from_v, PBVHVertRef to_v, bool /*is_duplicate*/, void *userdata)
{
  ...
  *SCULPT_vertex_attr_get<float *>(to_v, ss->attrs.automasking_factor) = 1.0f;
  *SCULPT_vertex_attr_get<float *>(from_v, ss->attrs.automasking_factor) = 1.0f;
...
static void SCULPT_topology_automasking_init(Sculpt *sd, Object *ob)
{
  ...
  for (int i : IndexRange(totvert)) {
    ...
    (*SCULPT_vertex_attr_get<float *>(vertex, ss->attrs.automasking_factor)) = 0.0f;
  }
                                                     ...
                                                     eAutomasking_flag mode)
{
  ...
  for (int i = 0; i < totvert; i++) {
    ...
    float f = *SCULPT_vertex_attr_get<float *>(vertex, ss->attrs.automasking_factor);
    ...
    *SCULPT_vertex_attr_get<float *>(vertex, ss->attrs.automasking_factor) = f;
  }
}
...
AutomaskingCache *SCULPT_automasking_cache_init(Sculpt *sd, const Brush *brush, Object *ob)
{
  ...
  for (int i : IndexRange(totvert)) {
    ...
    (*SCULPT_vertex_attr_get<float *>(vertex, ss->attrs.automasking_factor)) = initial_value;
  }

...
static void paint_draw_curve_cursor(Brush *brush, ViewContext *vc)
{
  ...
  if (brush->paint_curve && brush->paint_curve->points) {
    ...
    ui::UI_GetThemeColorType4fv(TH_VERTEX_SELECT, SPACE_VIEW3D, selec_col);
    ui::UI_GetThemeColorType4fv(TH_GIZMO_PRIMARY, SPACE_VIEW3D, handle_col);
    ui::UI_GetThemeColorType4fv(TH_GIZMO_SECONDARY, SPACE_VIEW3D, pivot_col);

...
wmOperatorStatus join_objects_exec(bContext *C, wmOperator *op)
{
  ...
  PointCloud &active_pointcloud = *blender::id_cast<PointCloud *>(active_object->data);
  ...
  for (const int i : objects.index_range()) {
    ...
    const PointCloud *orig_points = blender::id_cast<const PointCloud *>(objects[i]->data);

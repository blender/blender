 ...
 */
bool SEQ_time_strip_intersects_frame(const Scene *scene, const Strip *strip, int timeline_frame);
 ...
 */
float SEQ_time_media_playback_rate_factor_get(const Strip *strip, float frames_per_second);
/**

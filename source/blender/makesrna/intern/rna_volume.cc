...
const EnumPropertyItem rna_enum_volume_grid_data_type_items[] = {
    {VOLUME_GRID_BOOLEAN, "BOOLEAN", ICON_NODE_SOCKET_BOOLEAN, "Boolean", "Boolean"},
    {VOLUME_GRID_FLOAT, "FLOAT", ICON_NODE_SOCKET_FLOAT, "Float", "Single precision float"},
    {VOLUME_GRID_DOUBLE, "DOUBLE", ICON_NODE_SOCKET_FLOAT, "Double", "Double precision"},
    {VOLUME_GRID_INT, "INT", ICON_NODE_SOCKET_INT, "Integer", "32-bit integer"},
    {VOLUME_GRID_INT64, "INT64", ICON_NODE_SOCKET_INT, "Integer 64-bit", "64-bit integer"},
    {VOLUME_GRID_MASK,
     "MASK",
     ICON_NODE_SOCKET_BOOLEAN,
     "Mask",

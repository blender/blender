...
static void rna_def_linestyle_modifiers(BlenderRNA *brna)
{
  ...
  RNA_def_property_string_funcs(prop, NULL, NULL, "rna_LineStyleColorModifier_name_set");
  ...
  prop = RNA_def_property(srna, "name", PROP_STRING, PROP_NONE);
  RNA_def_property_string_sdna(prop, NULL, "name");
  RNA_def_property_string_funcs(prop, NULL, NULL, "rna_LineStyleAlphaModifier_name_set");
  RNA_def_property_ui_text(prop, "Modifier Name", "Name of the modifier");
  RNA_def_property_update(prop, NC_LINESTYLE, NULL);
  RNA_def_struct_name_property(srna, prop);
  ...
  prop = RNA_def_property(srna, "name", PROP_STRING, PROP_NONE);
  RNA_def_property_string_sdna(prop, NULL, "name");
  RNA_def_property_string_funcs(prop, NULL, NULL, "rna_LineStyleThicknessModifier_name_set");
  RNA_def_property_ui_text(prop, "Modifier Name", "Name of the modifier");
  RNA_def_property_update(prop, NC_LINESTYLE, NULL);
  RNA_def_struct_name_property(srna, prop);
  ...
  prop = RNA_def_property(srna, "name", PROP_STRING, PROP_NONE);
  RNA_def_property_string_sdna(prop, NULL, "name");
  RNA_def_property_string_funcs(prop, NULL, NULL, "rna_LineStyleGeometryModifier_name_set");
  RNA_def_property_ui_text(prop, "Modifier Name", "Name of the modifier");
  RNA_def_property_update(prop, NC_LINESTYLE, NULL);
  RNA_def_struct_name_property(srna, prop);

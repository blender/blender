...
{
  layout.prop(ptr, "voronoi_dimensions", ui::UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
  layout.prop(ptr, "feature", ui::UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
  ...
  {
    layout.prop(ptr, "distance", ui::UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);
  }

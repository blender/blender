                                               ...
                                               PointerRNA *ptr)
{
  ...
  layout.prop(ptr, "inside", ui::UI_ITEM_R_SPLIT_EMPTY_NAME, std::nullopt, ICON_NONE);
  layout.prop(ptr, "only_local", ui::UI_ITEM_R_SPLIT_EMPTY_NAME, std::nullopt, ICON_NONE);
}

...
/* NPR-Prototype. */
DefNode(ShaderNode,     SH_NODE_NPR_IMAGE_SAMPLE,   def_sh_image_sample,    NPR_ImageSample,  "Image Sample",      "Image Sample")
DefNode(ShaderNode,     SH_NODE_NPR_INPUT,          0,                      NPR_Input,        "NPR Input",         "NPR Input")
DefNode(ShaderNode,     SH_NODE_NPR_OUTPUT,         def_group_output,       NPR_Output,       "NPR Output",        "NPR Output")
DefNode(ShaderNode,     SH_NODE_NPR_REFRACTION,     0,                      NPR_Refraction,   "NPR Refraction",    "NPR Refraction")
DefNode(ShaderNode,     SH_NODE_INPUT_AOV,          def_sh_input_aov,       InputAOV,         "AOV Input",         "AOV Input")
DefNode(ShaderNode,     SH_NODE_REPEAT_INPUT,       def_sh_repeat_input,    RepeatInput,      "RepeatInput",       "Repeat Zone Input")
DefNode(ShaderNode,     SH_NODE_REPEAT_OUTPUT,      def_sh_repeat_output,   RepeatOutput,     "RepeatOutput",      "Repeat Zone Output")
DefNode(ShaderNode,     SH_NODE_FOREACH_LIGHT_INPUT,  def_sh_foreach_light_input,  ForeachLightInput,   "ForeachLightInput",    "For Each Light Zone Input")
DefNode(ShaderNode,     SH_NODE_FOREACH_LIGHT_OUTPUT, def_sh_foreach_light_output, ForeachLightOutput,  "ForeachLightOutput",   "For Each Light Zone Output")

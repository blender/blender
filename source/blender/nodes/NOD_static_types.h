...
DefNode(ShaderNode,     SH_NODE_FOREACH_LIGHT_INPUT,   def_sh_foreach_light_input,"FOREACH_LIGHT_INPUT",   ForeachLightInput,   "ForeachLightInput",    "For Each Light Zone Input")
DefNode(ShaderNode,     SH_NODE_FOREACH_LIGHT_OUTPUT,  def_sh_foreach_light_output,"FOREACH_LIGHT_OUTPUT", ForeachLightOutput,  "ForeachLightOutput",   "For Each Light Zone Output")

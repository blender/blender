...
DefNode(ShaderNode,     SH_NODE_LIGHT_LOOP_INPUT,   def_sh_light_loop_input,"LIGHT_LOOP_INPUT",   LightLoopInput,   "LightLoopInput",    "Light Loop Zone Input")
DefNode(ShaderNode,     SH_NODE_LIGHT_LOOP_OUTPUT,  def_sh_light_loop_output,"LIGHT_LOOP_OUTPUT", LightLoopOutput,  "LightLoopOutput",   "Light Loop Zone Output")

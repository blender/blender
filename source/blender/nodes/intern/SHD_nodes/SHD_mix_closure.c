...
static void node_shader_exec_mix_closure(void *data, bNode *node, bNodeStack **in, bNodeStack **UNUSED(out))
{
}

static int node_shader_gpu_mix_closure(GPUMaterial *mat, bNode *node, GPUNodeStack *in, GPUNodeStack *out)
{

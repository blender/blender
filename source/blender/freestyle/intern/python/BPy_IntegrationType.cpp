...
int IntegrationType_Init(PyObject *module)
{
  ...
  PyDict_SetItemString(IntegrationType_Type.tp_dict, "MEAN", PyLong_FromLong(MEAN));
  PyDict_SetItemString(IntegrationType_Type.tp_dict, "MIN", PyLong_FromLong(MIN));
  PyDict_SetItemString(IntegrationType_Type.tp_dict, "MAX", PyLong_FromLong(MAX));
  PyDict_SetItemString(IntegrationType_Type.tp_dict, "FIRST", PyLong_FromLong(FIRST));
  PyDict_SetItemString(IntegrationType_Type.tp_dict, "LAST", PyLong_FromLong(LAST));

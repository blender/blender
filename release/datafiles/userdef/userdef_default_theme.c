  ...
  .tarm = {
    {
      ...
      .select = RGBA(0xff7f71ff),
      .active = RGBA(0xffe9e6ff),
    },
    {
      .solid = RGBA(0xd2a087ff),
      .select = RGBA(0xeeb899ff),
      .active = RGBA(0xffefe6ff),
    },
    {
      .solid = RGBA(0xd2944dff),
      .select = RGBA(0xeda348ff),
      .active = RGBA(0xfff4e6ff),
    },
    {
      .solid = RGBA(0xd5bb3aff),
      .select = RGBA(0xd0b639ff),
      .active = RGBA(0xfffbe6ff),
    },
    {
      .solid = RGBA(0xb9b379ff),
      .select = RGBA(0xbcb57bff),
      .active = RGBA(0xfffce6ff),
    },
    {
      .solid = RGBA(0x9fbe39ff),
      .select = RGBA(0xacc13aff),
      .active = RGBA(0xfbffe6ff),
    },
    {
      .solid = RGBA(0x7bc83bff),
      .select = RGBA(0x85cc3cff),
      .active = RGBA(0xf3ffe6ff),
    },
    {
      .solid = RGBA(0xa2c491ff),
      .select = RGBA(0xa1bc8bff),
      .active = RGBA(0xf1ffe6ff),
    },
    {
      .solid = RGBA(0x2ebe4aff),
      .select = RGBA(0x37e14eff),
      .active = RGBA(0xe6ffe9ff),
    },
    {
    ...
    },
    {
      ...
      .select = RGBA(0x35da9eff),
      .active = RGBA(0xe6fff6ff),
    },
    {
      .solid = RGBA(0x3ad5d4ff),
      .select = RGBA(0x3bd2d7ff),
      .active = RGBA(0xe6feffff),
    },
    {
      .solid = RGBA(0x61b0ddff),
      .select = RGBA(0x6bc1f3ff),
      .active = RGBA(0xe6f6ffff),
    },
    {

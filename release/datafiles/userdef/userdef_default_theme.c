...
const bTheme U_theme_default = {
  ...
  .space_sequencer = {
    ...
    .outline_width = 1,
    .facedot_size = 4,
    .movie = RGBA(0x2b6090ff),
    .movieclip = RGBA(0x8f4c4cff),
    .mask = RGBA(0xb3b3b3ff),
    .image = RGBA(0x595959ff),
    .scene = RGBA(0x828f50ff),
    .audio = RGBA(0x4c7e8fff),
    ...
    .selected_strip = RGBA(0xffb68eff),
    .gp_vertex_size = 3,
    .gp_vertex_select = RGBA(0xff8500ff),
    .anim_preview_range = RGBA(0xa14d0066),
